 ...
 *
 * @Kubernetes\Kind("JobList",group="batch",version="v1")
 *
 * @implements \IteratorAggregate<int, Job>
 */
class JobList implements IteratorAggregate
{
    ...
    /**
     * @Kubernetes\Attribute("items",type="collection",model=Job::class,isRequired=true)
     * @var iterable|Job[]
     */
    protected $items;
    ...
    /**
     * @return ArrayIterator|iterable|Job[]
     */
     ...
     * @return static
     */
    public function addItems(Job $item)
    {
        if (!$this->items) {

 ...
 *
 * @Kubernetes\Kind("LimitRangeList",version="v1")
 *
 * @implements \IteratorAggregate<int, LimitRange>
 */
class LimitRangeList implements IteratorAggregate
{
    /**
    ...
    /**
     * @Kubernetes\Attribute("items",type="collection",model=LimitRange::class,isRequired=true)
     * @var iterable|LimitRange[]
     */
    protected $items;
    ...
    /**
     * @param iterable|LimitRange[] $items
     */
    ...
    /**
     * @return ArrayIterator|iterable|LimitRange[]
     */
     ...
     * @return static
     */
    public function addItems(LimitRange $item)
    {
        if (!$this->items) {

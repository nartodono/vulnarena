 ...
 *
 * @Kubernetes\Kind("ClusterRoleBindingList",group="rbac.authorization.k8s.io",version="v1")
 *
 * @implements \IteratorAggregate<int, ClusterRoleBinding>
 */
class ClusterRoleBindingList implements IteratorAggregate
{
    /**
    ...
    /**
     * @Kubernetes\Attribute("items",type="collection",model=ClusterRoleBinding::class,isRequired=true)
     * @var iterable|ClusterRoleBinding[]
     */
    protected $items;
     ...
     * @var string|null
     */
    protected $kind = 'ClusterRoleBindingList';
    ...
    /**
     * @param iterable|ClusterRoleBinding[] $items
     */
    ...
    /**
     * @return ArrayIterator|iterable|ClusterRoleBinding[]
     */
     ...
     *
     * @return iterable|ClusterRoleBinding[]
     */
     ...
     * @return static
     */
    public function addItems(ClusterRoleBinding $item)
    {
        if (!$this->items) {

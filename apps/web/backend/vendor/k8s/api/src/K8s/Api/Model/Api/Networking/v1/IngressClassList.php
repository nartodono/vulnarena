 ...
 *
 * @Kubernetes\Kind("IngressClassList",group="networking.k8s.io",version="v1")
 *
 * @implements \IteratorAggregate<int, IngressClass>
 */
class IngressClassList implements IteratorAggregate
{
    /**
    ...
    /**
     * @Kubernetes\Attribute("items",type="collection",model=IngressClass::class,isRequired=true)
     * @var iterable|IngressClass[]
     */
    protected $items;
     ...
     * @var string|null
     */
    protected $kind = 'IngressClassList';
    ...
    /**
     * @param iterable|IngressClass[] $items
     */
    ...
    /**
     * @return ArrayIterator|iterable|IngressClass[]
     */
     ...
     * @return static
     */
    public function addItems(IngressClass $item)
    {
        if (!$this->items) {

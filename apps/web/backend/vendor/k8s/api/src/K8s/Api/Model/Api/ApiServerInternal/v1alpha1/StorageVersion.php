 ...
 *
 * @Kubernetes\Kind("StorageVersion",group="internal.apiserver.k8s.io",version="v1alpha1")
 * @Kubernetes\Operation("get",path="/apis/internal.apiserver.k8s.io/v1alpha1/storageversions/{name}",response="static::class")
 * @Kubernetes\Operation("get-status",path="/apis/internal.apiserver.k8s.io/v1alpha1/storageversions/{name}/status",response="static::class")
 * @Kubernetes\Operation("post",path="/apis/internal.apiserver.k8s.io/v1alpha1/storageversions",body="model",response="static::class")
 * @Kubernetes\Operation("delete",path="/apis/internal.apiserver.k8s.io/v1alpha1/storageversions/{name}",response="K8s\Api\Model\ApiMachinery\Apis\Meta\v1\Status")
 * @Kubernetes\Operation("put",path="/apis/internal.apiserver.k8s.io/v1alpha1/storageversions/{name}",body="model",response="static::class")
 * @Kubernetes\Operation("put-status",path="/apis/internal.apiserver.k8s.io/v1alpha1/storageversions/{name}/status",body="model",response="static::class")
 * @Kubernetes\Operation("deletecollection-all",path="/apis/internal.apiserver.k8s.io/v1alpha1/storageversions",response="K8s\Api\Model\ApiMachinery\Apis\Meta\v1\Status")
 * @Kubernetes\Operation("watch-all",path="/apis/internal.apiserver.k8s.io/v1alpha1/storageversions",response="K8s\Api\Model\ApiMachinery\Apis\Meta\v1\WatchEvent")
 * @Kubernetes\Operation("patch",path="/apis/internal.apiserver.k8s.io/v1alpha1/storageversions/{name}",body="patch",response="static::class")
 * @Kubernetes\Operation("patch-status",path="/apis/internal.apiserver.k8s.io/v1alpha1/storageversions/{name}/status",body="patch",response="static::class")
 * @Kubernetes\Operation("list-all",path="/apis/internal.apiserver.k8s.io/v1alpha1/storageversions",response="K8s\Api\Model\Api\ApiServerInternal\v1alpha1\StorageVersionList")
 */
class StorageVersion
{
     ...
     * @var string
     */
    protected $apiVersion = 'internal.apiserver.k8s.io/v1alpha1';

    /**
     * @Kubernetes\Attribute("kind")
     * @var string
     */
    protected $kind = 'StorageVersion';
    ...
    /**
     * @Kubernetes\Attribute("spec",isRequired=true)
     * @var object
     */
    protected $spec;

    /**
     * @Kubernetes\Attribute("status",type="model",model=StorageVersionStatus::class,isRequired=true)
    ...
    /**
     * @param object $spec
     * @param StorageVersionStatus $status
     */
    public function __construct(?string $name, $spec, StorageVersionStatus $status)
    {
    ...
    {
        return $this->status->getCommonEncodingVersion();
    }
    ...
    {
        return $this->status->getStorageVersions();
    }
    ...
    /**
     * API server instances report the version they can decode and the version they encode objects to when
     * persisting objects in the backend.
     */
    public function getStatus(): StorageVersionStatus
    {
        return $this->status;
    }
     ...
     * @return static
     */
    public function setStatus(StorageVersionStatus $status)
    {
        $this->status = $status;

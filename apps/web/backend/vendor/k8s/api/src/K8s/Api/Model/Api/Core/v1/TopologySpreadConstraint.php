...
class TopologySpreadConstraint
{
     ...
     * @var int|null
     */
    protected $minDomains = null;

    /**
     * @Kubernetes\Attribute("nodeAffinityPolicy")
     * @var string|null
     */
    protected $nodeAffinityPolicy = null;

    /**
     * @Kubernetes\Attribute("nodeTaintsPolicy")
     * @var string|null
     */
    protected $nodeTaintsPolicy = null;
     ...
     * calculated for the incoming pod. Keys that don't exist in the incoming pod labels will be ignored. A
     ...
     *
     * This is a beta field and requires the MinDomainsInPodTopologySpread feature gate to be enabled
     * (enabled by default).
     */
    public function getMinDomains(): ?int
    {
     ...
     * @return static
     */
    public function setMinDomains(int $minDomains)
    {
     ...
     *
     * If this value is nil, the behavior is equivalent to the Honor policy. This is a alpha-level feature
     * enabled by the NodeInclusionPolicyInPodTopologySpread feature flag.
     */
    public function getNodeAffinityPolicy(): ?string
    {
     ...
     * @return static
     */
    public function setNodeAffinityPolicy(string $nodeAffinityPolicy)
    {
     ...
     *
     * If this value is nil, the behavior is equivalent to the Ignore policy. This is a alpha-level feature
     * enabled by the NodeInclusionPolicyInPodTopologySpread feature flag.
     */
    public function getNodeTaintsPolicy(): ?string
    {
     ...
     * @return static
     */
    public function setNodeTaintsPolicy(string $nodeTaintsPolicy)
    {

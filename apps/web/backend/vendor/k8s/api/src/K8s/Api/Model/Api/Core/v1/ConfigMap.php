 ...
 * @Kubernetes\Operation("get",path="/api/v1/namespaces/{namespace}/configmaps/{name}",response="static::class")
 * @Kubernetes\Operation("post",path="/api/v1/namespaces/{namespace}/configmaps",body="model",response="static::class")
 * @Kubernetes\Operation("delete",path="/api/v1/namespaces/{namespace}/configmaps/{name}",response="K8s\Api\Model\ApiMachinery\Apis\Meta\v1\Status")
 * @Kubernetes\Operation("watch",path="/api/v1/namespaces/{namespace}/configmaps",response="K8s\Api\Model\ApiMachinery\Apis\Meta\v1\WatchEvent")
 * @Kubernetes\Operation("put",path="/api/v1/namespaces/{namespace}/configmaps/{name}",body="model",response="static::class")
 * @Kubernetes\Operation("deletecollection",path="/api/v1/namespaces/{namespace}/configmaps",response="K8s\Api\Model\ApiMachinery\Apis\Meta\v1\Status")
 * @Kubernetes\Operation("watch-all",path="/api/v1/configmaps",response="K8s\Api\Model\ApiMachinery\Apis\Meta\v1\WatchEvent")
 * @Kubernetes\Operation("patch",path="/api/v1/namespaces/{namespace}/configmaps/{name}",body="patch",response="static::class")
 * @Kubernetes\Operation("list",path="/api/v1/namespaces/{namespace}/configmaps",response="K8s\Api\Model\Api\Core\v1\ConfigMapList")
 * @Kubernetes\Operation("list-all",path="/api/v1/configmaps",response="K8s\Api\Model\Api\Core\v1\ConfigMapList")
 */
class ConfigMap
{
    /**
    ...
    /**
     * @Kubernetes\Attribute("binaryData")
     * @var string[]|null
     */
    ...
    /**
     * @Kubernetes\Attribute("immutable")
     * @var bool|null
     */
     ...
     * @return static
     */
    public function setBinaryData(array $binaryData)
    {
     ...
     * '.'. Values with non-UTF-8 byte sequences must use the BinaryData field. The keys stored in Data
     * must not overlap with the keys in the BinaryData field, this is enforced during validation process.
     */
    ...
    /**
     * Immutable, if set to true, ensures that data stored in the ConfigMap cannot be updated (only object
     ...
     * @return static
     */
    public function setIsImmutable(bool $immutable)
    {

 ...
 *
 * @Kubernetes\Kind("DaemonSet",group="apps",version="v1")
 * @Kubernetes\Operation("get",path="/apis/apps/v1/namespaces/{namespace}/daemonsets/{name}",response="static::class")
 * @Kubernetes\Operation("get-status",path="/apis/apps/v1/namespaces/{namespace}/daemonsets/{name}/status",response="static::class")
 * @Kubernetes\Operation("post",path="/apis/apps/v1/namespaces/{namespace}/daemonsets",body="model",response="static::class")
 * @Kubernetes\Operation("delete",path="/apis/apps/v1/namespaces/{namespace}/daemonsets/{name}",response="K8s\Api\Model\ApiMachinery\Apis\Meta\v1\Status")
 * @Kubernetes\Operation("watch",path="/apis/apps/v1/namespaces/{namespace}/daemonsets",response="K8s\Api\Model\ApiMachinery\Apis\Meta\v1\WatchEvent")
 * @Kubernetes\Operation("put",path="/apis/apps/v1/namespaces/{namespace}/daemonsets/{name}",body="model",response="static::class")
 * @Kubernetes\Operation("put-status",path="/apis/apps/v1/namespaces/{namespace}/daemonsets/{name}/status",body="model",response="static::class")
 * @Kubernetes\Operation("deletecollection",path="/apis/apps/v1/namespaces/{namespace}/daemonsets",response="K8s\Api\Model\ApiMachinery\Apis\Meta\v1\Status")
 * @Kubernetes\Operation("watch-all",path="/apis/apps/v1/daemonsets",response="K8s\Api\Model\ApiMachinery\Apis\Meta\v1\WatchEvent")
 * @Kubernetes\Operation("patch",path="/apis/apps/v1/namespaces/{namespace}/daemonsets/{name}",body="patch",response="static::class")
 * @Kubernetes\Operation("patch-status",path="/apis/apps/v1/namespaces/{namespace}/daemonsets/{name}/status",body="patch",response="static::class")
 * @Kubernetes\Operation("list",path="/apis/apps/v1/namespaces/{namespace}/daemonsets",response="K8s\Api\Model\Api\Apps\v1\DaemonSetList")
 * @Kubernetes\Operation("list-all",path="/apis/apps/v1/daemonsets",response="K8s\Api\Model\Api\Apps\v1\DaemonSetList")
 */
class DaemonSet
{
    /**
    ...
    /**
     * @Kubernetes\Attribute("spec",type="model",model=DaemonSetSpec::class)
     * @var DaemonSetSpec
     */
    protected $spec;

    /**
     * @Kubernetes\Attribute("status",type="model",model=DaemonSetStatus::class)
     * @var DaemonSetStatus|null
     */
    ...
    public function __construct(?string $name, LabelSelector $selector, PodTemplateSpec $template)
    {
        ...
        $this->spec = new DaemonSetSpec($selector, $template);
    }
    ...
    {
        return $this->status->getCurrentNumberScheduled();
    }
    ...
    {
        return $this->status->getDesiredNumberScheduled();
    }
    ...
    {
        return $this->status->getNumberAvailable();
    }
    ...
    {
        return $this->status->getNumberMisscheduled();
    }
    ...
    {
        return $this->status->getNumberReady();
    }
    ...
    {
        return $this->status->getNumberUnavailable();
    }
    ...
    {
        return $this->status->getUpdatedNumberScheduled();
    }
     ...
     */
    public function getSpec(): DaemonSetSpec
    {
        return $this->spec;
    }
     ...
     * @return static
     */
    public function setSpec(DaemonSetSpec $spec)
    {
        $this->spec = $spec;
     ...
     * https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#spec-and-status
     */
    public function getStatus(): ?DaemonSetStatus
    {
        return $this->status;
    }
}

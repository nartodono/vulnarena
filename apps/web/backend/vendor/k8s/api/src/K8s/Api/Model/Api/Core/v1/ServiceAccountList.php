 ...
 *
 * @Kubernetes\Kind("ServiceAccountList",version="v1")
 *
 * @implements \IteratorAggregate<int, ServiceAccount>
 */
class ServiceAccountList implements IteratorAggregate
{
    /**
    ...
    /**
     * @Kubernetes\Attribute("items",type="collection",model=ServiceAccount::class,isRequired=true)
     * @var iterable|ServiceAccount[]
     */
    protected $items;
     ...
     * @var string|null
     */
    protected $kind = 'ServiceAccountList';
    ...
    /**
     * @param iterable|ServiceAccount[] $items
     */
    ...
    /**
     * @return ArrayIterator|iterable|ServiceAccount[]
     */
     ...
     *
     * @return iterable|ServiceAccount[]
     */
     ...
     * @return static
     */
    public function addItems(ServiceAccount $item)
    {
        if (!$this->items) {

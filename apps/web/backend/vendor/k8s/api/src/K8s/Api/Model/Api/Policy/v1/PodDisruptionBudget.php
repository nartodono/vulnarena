 ...
 * pods
 *
 * @Kubernetes\Kind("PodDisruptionBudget",group="policy",version="v1")
 * @Kubernetes\Operation("get",path="/apis/policy/v1/namespaces/{namespace}/poddisruptionbudgets/{name}",response="static::class")
 * @Kubernetes\Operation("get-status",path="/apis/policy/v1/namespaces/{namespace}/poddisruptionbudgets/{name}/status",response="static::class")
 * @Kubernetes\Operation("post",path="/apis/policy/v1/namespaces/{namespace}/poddisruptionbudgets",body="model",response="static::class")
 * @Kubernetes\Operation("delete",path="/apis/policy/v1/namespaces/{namespace}/poddisruptionbudgets/{name}",response="K8s\Api\Model\ApiMachinery\Apis\Meta\v1\Status")
 * @Kubernetes\Operation("watch",path="/apis/policy/v1/namespaces/{namespace}/poddisruptionbudgets",response="K8s\Api\Model\ApiMachinery\Apis\Meta\v1\WatchEvent")
 * @Kubernetes\Operation("put",path="/apis/policy/v1/namespaces/{namespace}/poddisruptionbudgets/{name}",body="model",response="static::class")
 * @Kubernetes\Operation("put-status",path="/apis/policy/v1/namespaces/{namespace}/poddisruptionbudgets/{name}/status",body="model",response="static::class")
 * @Kubernetes\Operation("deletecollection",path="/apis/policy/v1/namespaces/{namespace}/poddisruptionbudgets",response="K8s\Api\Model\ApiMachinery\Apis\Meta\v1\Status")
 * @Kubernetes\Operation("watch-all",path="/apis/policy/v1/poddisruptionbudgets",response="K8s\Api\Model\ApiMachinery\Apis\Meta\v1\WatchEvent")
 * @Kubernetes\Operation("patch",path="/apis/policy/v1/namespaces/{namespace}/poddisruptionbudgets/{name}",body="patch",response="static::class")
 * @Kubernetes\Operation("patch-status",path="/apis/policy/v1/namespaces/{namespace}/poddisruptionbudgets/{name}/status",body="patch",response="static::class")
 * @Kubernetes\Operation("list",path="/apis/policy/v1/namespaces/{namespace}/poddisruptionbudgets",response="K8s\Api\Model\Api\Policy\v1\PodDisruptionBudgetList")
 * @Kubernetes\Operation("list-all",path="/apis/policy/v1/poddisruptionbudgets",response="K8s\Api\Model\Api\Policy\v1\PodDisruptionBudgetList")
 */
class PodDisruptionBudget
{
     ...
     * @var string
     */
    protected $apiVersion = 'policy/v1';

    /**
     * @Kubernetes\Attribute("kind")
     * @var string
     */
    protected $kind = 'PodDisruptionBudget';
    ...
    /**
     * @Kubernetes\Attribute("spec",type="model",model=PodDisruptionBudgetSpec::class)
     * @var PodDisruptionBudgetSpec
     */
    protected $spec;

    /**
     * @Kubernetes\Attribute("status",type="model",model=PodDisruptionBudgetStatus::class)
     * @var PodDisruptionBudgetStatus|null
     */
    ...
    {
        return $this->spec->getMaxUnavailable();
    }
    ...
    {
        $this->spec->setMaxUnavailable($maxUnavailable);
    ...
    {
        return $this->spec->getMinAvailable();
    }
    ...
    {
        $this->spec->setMinAvailable($minAvailable);
    ...
    {
        return $this->status->getCurrentHealthy();
    }
    ...
    {
        return $this->status->getDesiredHealthy();
    }
    ...
    {
        return $this->status->getDisruptedPods();
    }
    ...
    {
        return $this->status->getDisruptionsAllowed();
    }
    ...
    {
        return $this->status->getExpectedPods();
    }
     ...
     */
    public function getSpec(): PodDisruptionBudgetSpec
    {
        return $this->spec;
    }
     ...
     * @return static
     */
    public function setSpec(PodDisruptionBudgetSpec $spec)
    {
        $this->spec = $spec;
     ...
     */
    public function getStatus(): ?PodDisruptionBudgetStatus
    {
        return $this->status;
    }
     ...
     * @return static
     */
    public function setStatus(PodDisruptionBudgetStatus $status)
    {
        $this->status = $status;

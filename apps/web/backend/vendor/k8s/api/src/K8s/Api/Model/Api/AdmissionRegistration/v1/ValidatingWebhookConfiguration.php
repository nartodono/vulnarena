 ...
 * @Kubernetes\Operation("get",path="/apis/admissionregistration.k8s.io/v1/validatingwebhookconfigurations/{name}",response="static::class")
 * @Kubernetes\Operation("post",path="/apis/admissionregistration.k8s.io/v1/validatingwebhookconfigurations",body="model",response="static::class")
 * @Kubernetes\Operation("delete",path="/apis/admissionregistration.k8s.io/v1/validatingwebhookconfigurations/{name}",response="K8s\Api\Model\ApiMachinery\Apis\Meta\v1\Status")
 * @Kubernetes\Operation("put",path="/apis/admissionregistration.k8s.io/v1/validatingwebhookconfigurations/{name}",body="model",response="static::class")
 * @Kubernetes\Operation("deletecollection-all",path="/apis/admissionregistration.k8s.io/v1/validatingwebhookconfigurations",response="K8s\Api\Model\ApiMachinery\Apis\Meta\v1\Status")
 * @Kubernetes\Operation("watch-all",path="/apis/admissionregistration.k8s.io/v1/validatingwebhookconfigurations",response="K8s\Api\Model\ApiMachinery\Apis\Meta\v1\WatchEvent")
 * @Kubernetes\Operation("patch",path="/apis/admissionregistration.k8s.io/v1/validatingwebhookconfigurations/{name}",body="patch",response="static::class")
 * @Kubernetes\Operation("list-all",path="/apis/admissionregistration.k8s.io/v1/validatingwebhookconfigurations",response="K8s\Api\Model\Api\AdmissionRegistration\v1\ValidatingWebhookConfigurationList")
 */
class ValidatingWebhookConfiguration
{
     ...
     * @var string|null
     */
    protected $kind = 'ValidatingWebhookConfiguration';
    ...
    /**
     * @Kubernetes\Attribute("webhooks",type="collection",model=ValidatingWebhook::class)
     * @var iterable|ValidatingWebhook[]|null
     */
     ...
     *
     * @return iterable|ValidatingWebhook[]
     */
     ...
     * @return static
     */
    public function addWebhooks(ValidatingWebhook $webhook)
    {
        if (!$this->webhooks) {

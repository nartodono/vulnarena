 ...
 * name>/evictions.
 *
 * @Kubernetes\Kind("Eviction",group="policy",version="v1")
 * @Kubernetes\Operation("post",path="/api/v1/namespaces/{namespace}/pods/{name}/eviction",body="model",response="static::class")
 */
class Eviction
{
    /**
    ...
    /**
     * @Kubernetes\Attribute("deleteOptions",type="model",model=DeleteOptions::class)
     * @var DeleteOptions|null
     */
    protected $deleteOptions = null;

    /**
     * @Kubernetes\Attribute("kind")
     * @var string|null
     */
    protected $kind = 'Eviction';
     ...
     */
    public function getDeleteOptions(): ?DeleteOptions
    {
     ...
     * @return static
     */
    public function setDeleteOptions(DeleteOptions $deleteOptions)
    {

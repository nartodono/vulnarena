 ...
 * @Kubernetes\Operation("get",path="/api/v1/namespaces/{namespace}/serviceaccounts/{name}",response="static::class")
 * @Kubernetes\Operation("post",path="/api/v1/namespaces/{namespace}/serviceaccounts",body="model",response="static::class")
 * @Kubernetes\Operation("delete",path="/api/v1/namespaces/{namespace}/serviceaccounts/{name}",response="static::class")
 * @Kubernetes\Operation("watch",path="/api/v1/namespaces/{namespace}/serviceaccounts",response="K8s\Api\Model\ApiMachinery\Apis\Meta\v1\WatchEvent")
 * @Kubernetes\Operation("put",path="/api/v1/namespaces/{namespace}/serviceaccounts/{name}",body="model",response="static::class")
 * @Kubernetes\Operation("deletecollection",path="/api/v1/namespaces/{namespace}/serviceaccounts",response="K8s\Api\Model\ApiMachinery\Apis\Meta\v1\Status")
 * @Kubernetes\Operation("watch-all",path="/api/v1/serviceaccounts",response="K8s\Api\Model\ApiMachinery\Apis\Meta\v1\WatchEvent")
 * @Kubernetes\Operation("patch",path="/api/v1/namespaces/{namespace}/serviceaccounts/{name}",body="patch",response="static::class")
 * @Kubernetes\Operation("list",path="/api/v1/namespaces/{namespace}/serviceaccounts",response="K8s\Api\Model\Api\Core\v1\ServiceAccountList")
 * @Kubernetes\Operation("list-all",path="/api/v1/serviceaccounts",response="K8s\Api\Model\Api\Core\v1\ServiceAccountList")
 */
class ServiceAccount
{
    ...
    /**
     * @Kubernetes\Attribute("secrets",type="collection",model=ObjectReference::class)
     ...
     * @return static
     */
    public function setSecrets(iterable $secrets)
    {
     ...
     * @return static
     */
    public function addSecrets(ObjectReference $secret)
    {
        if (!$this->secrets) {

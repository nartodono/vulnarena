 ...
 * @Kubernetes\Operation("get",path="/apis/rbac.authorization.k8s.io/v1/namespaces/{namespace}/roles/{name}",response="static::class")
 * @Kubernetes\Operation("post",path="/apis/rbac.authorization.k8s.io/v1/namespaces/{namespace}/roles",body="model",response="static::class")
 * @Kubernetes\Operation("delete",path="/apis/rbac.authorization.k8s.io/v1/namespaces/{namespace}/roles/{name}",response="K8s\Api\Model\ApiMachinery\Apis\Meta\v1\Status")
 * @Kubernetes\Operation("watch",path="/apis/rbac.authorization.k8s.io/v1/namespaces/{namespace}/roles",response="K8s\Api\Model\ApiMachinery\Apis\Meta\v1\WatchEvent")
 * @Kubernetes\Operation("put",path="/apis/rbac.authorization.k8s.io/v1/namespaces/{namespace}/roles/{name}",body="model",response="static::class")
 * @Kubernetes\Operation("deletecollection",path="/apis/rbac.authorization.k8s.io/v1/namespaces/{namespace}/roles",response="K8s\Api\Model\ApiMachinery\Apis\Meta\v1\Status")
 * @Kubernetes\Operation("watch-all",path="/apis/rbac.authorization.k8s.io/v1/roles",response="K8s\Api\Model\ApiMachinery\Apis\Meta\v1\WatchEvent")
 * @Kubernetes\Operation("patch",path="/apis/rbac.authorization.k8s.io/v1/namespaces/{namespace}/roles/{name}",body="patch",response="static::class")
 * @Kubernetes\Operation("list",path="/apis/rbac.authorization.k8s.io/v1/namespaces/{namespace}/roles",response="K8s\Api\Model\Api\Rbac\v1\RoleList")
 * @Kubernetes\Operation("list-all",path="/apis/rbac.authorization.k8s.io/v1/roles",response="K8s\Api\Model\Api\Rbac\v1\RoleList")
 */
class Role
{
    /**

 ...
 *
 * @Kubernetes\Kind("ResourceQuotaList",version="v1")
 *
 * @implements \IteratorAggregate<int, ResourceQuota>
 */
class ResourceQuotaList implements IteratorAggregate
{
    /**
    ...
    /**
     * @Kubernetes\Attribute("items",type="collection",model=ResourceQuota::class,isRequired=true)
     * @var iterable|ResourceQuota[]
     */
    protected $items;
     ...
     * @var string|null
     */
    protected $kind = 'ResourceQuotaList';
    ...
    /**
     * @param iterable|ResourceQuota[] $items
     */
    ...
    /**
     * @return ArrayIterator|iterable|ResourceQuota[]
     */
     ...
     * @return static
     */
    public function addItems(ResourceQuota $item)
    {
        if (!$this->items) {

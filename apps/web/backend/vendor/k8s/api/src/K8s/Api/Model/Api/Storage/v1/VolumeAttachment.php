 ...
 *
 * @Kubernetes\Kind("VolumeAttachment",group="storage.k8s.io",version="v1")
 * @Kubernetes\Operation("get",path="/apis/storage.k8s.io/v1/volumeattachments/{name}",response="static::class")
 * @Kubernetes\Operation("get-status",path="/apis/storage.k8s.io/v1/volumeattachments/{name}/status",response="static::class")
 * @Kubernetes\Operation("post",path="/apis/storage.k8s.io/v1/volumeattachments",body="model",response="static::class")
 * @Kubernetes\Operation("delete",path="/apis/storage.k8s.io/v1/volumeattachments/{name}",response="static::class")
 * @Kubernetes\Operation("put",path="/apis/storage.k8s.io/v1/volumeattachments/{name}",body="model",response="static::class")
 * @Kubernetes\Operation("put-status",path="/apis/storage.k8s.io/v1/volumeattachments/{name}/status",body="model",response="static::class")
 * @Kubernetes\Operation("deletecollection-all",path="/apis/storage.k8s.io/v1/volumeattachments",response="K8s\Api\Model\ApiMachinery\Apis\Meta\v1\Status")
 * @Kubernetes\Operation("watch-all",path="/apis/storage.k8s.io/v1/volumeattachments",response="K8s\Api\Model\ApiMachinery\Apis\Meta\v1\WatchEvent")
 * @Kubernetes\Operation("patch",path="/apis/storage.k8s.io/v1/volumeattachments/{name}",body="patch",response="static::class")
 * @Kubernetes\Operation("patch-status",path="/apis/storage.k8s.io/v1/volumeattachments/{name}/status",body="patch",response="static::class")
 * @Kubernetes\Operation("list-all",path="/apis/storage.k8s.io/v1/volumeattachments",response="K8s\Api\Model\Api\Storage\v1\VolumeAttachmentList")
 */
class VolumeAttachment
{
     ...
     * @var string
     */
    protected $kind = 'VolumeAttachment';
    ...
    /**
     * @Kubernetes\Attribute("spec",type="model",model=VolumeAttachmentSpec::class,isRequired=true)
     * @var VolumeAttachmentSpec
     */
    protected $spec;

    /**
     * @Kubernetes\Attribute("status",type="model",model=VolumeAttachmentStatus::class)
     * @var VolumeAttachmentStatus|null
     */
     ...
     */
    public function __construct(?string $name, string $attacher, string $nodeName, VolumeAttachmentSource $source)
    {
        $this->metadata = new ObjectMeta($name);
        $this->spec = new VolumeAttachmentSpec($attacher, $nodeName, $source);
    }
    ...
    {
        $this->spec->setAttacher($attacher);
    ...
    {
        return $this->status->getAttachError();
    }
    ...
    {
        return $this->status->getAttachmentMetadata();
    }
    ...
    {
        return $this->status->getDetachError();
    }
     ...
     * @return static
     */
    public function setSpec(VolumeAttachmentSpec $spec)
    {
        $this->spec = $spec;
     ...
     */
    public function getStatus(): ?VolumeAttachmentStatus
    {
        return $this->status;
    }
     ...
     * @return static
     */
    public function setStatus(VolumeAttachmentStatus $status)
    {
        $this->status = $status;

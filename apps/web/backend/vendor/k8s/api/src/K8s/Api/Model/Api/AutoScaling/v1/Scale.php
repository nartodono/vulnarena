 ...
 *
 * @Kubernetes\Kind("Scale",group="autoscaling",version="v1")
 */
class Scale
{
    /**
    ...
    /**
     * @Kubernetes\Attribute("spec",type="model",model=ScaleSpec::class)
     * @var ScaleSpec
     */
    protected $spec;

    /**
     * @Kubernetes\Attribute("status",type="model",model=ScaleStatus::class)
     * @var ScaleStatus|null
     */
    ...
    {
        return $this->status->getSelector();
    }
     ...
     */
    public function getSpec(): ScaleSpec
    {
        return $this->spec;
    }
     ...
     * @return static
     */
    public function setSpec(ScaleSpec $spec)
    {
        $this->spec = $spec;
     ...
     * Read-only.
     */
    public function getStatus(): ?ScaleStatus
    {
        return $this->status;
    }
}

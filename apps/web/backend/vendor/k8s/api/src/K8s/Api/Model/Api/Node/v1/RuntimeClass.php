 ...
 *
 * @Kubernetes\Kind("RuntimeClass",group="node.k8s.io",version="v1")
 * @Kubernetes\Operation("get",path="/apis/node.k8s.io/v1/runtimeclasses/{name}",response="static::class")
 * @Kubernetes\Operation("post",path="/apis/node.k8s.io/v1/runtimeclasses",body="model",response="static::class")
 * @Kubernetes\Operation("delete",path="/apis/node.k8s.io/v1/runtimeclasses/{name}",response="K8s\Api\Model\ApiMachinery\Apis\Meta\v1\Status")
 * @Kubernetes\Operation("put",path="/apis/node.k8s.io/v1/runtimeclasses/{name}",body="model",response="static::class")
 * @Kubernetes\Operation("deletecollection-all",path="/apis/node.k8s.io/v1/runtimeclasses",response="K8s\Api\Model\ApiMachinery\Apis\Meta\v1\Status")
 * @Kubernetes\Operation("watch-all",path="/apis/node.k8s.io/v1/runtimeclasses",response="K8s\Api\Model\ApiMachinery\Apis\Meta\v1\WatchEvent")
 * @Kubernetes\Operation("patch",path="/apis/node.k8s.io/v1/runtimeclasses/{name}",body="patch",response="static::class")
 * @Kubernetes\Operation("list-all",path="/apis/node.k8s.io/v1/runtimeclasses",response="K8s\Api\Model\Api\Node\v1\RuntimeClassList")
 */
class RuntimeClass
{
    /**
     ...
     * @var string|null
     */
    protected $apiVersion = 'node.k8s.io/v1';
     ...
     * native Linux containers) will be used to run the containers in a pod. The Handler must be lowercase,

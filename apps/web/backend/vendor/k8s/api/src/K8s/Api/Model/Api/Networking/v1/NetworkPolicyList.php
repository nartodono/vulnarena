 ...
 *
 * @Kubernetes\Kind("NetworkPolicyList",group="networking.k8s.io",version="v1")
 *
 * @implements \IteratorAggregate<int, NetworkPolicy>
 */
class NetworkPolicyList implements IteratorAggregate
{
    ...
    /**
     * @Kubernetes\Attribute("items",type="collection",model=NetworkPolicy::class,isRequired=true)
     * @var iterable|NetworkPolicy[]
     */
    protected $items;
     ...
     * @var string|null
     */
    protected $kind = 'NetworkPolicyList';
    ...
    /**
     * @param iterable|NetworkPolicy[] $items
     */
    ...
    /**
     * @return ArrayIterator|iterable|NetworkPolicy[]
     */
     ...
     * @return static
     */
    public function addItems(NetworkPolicy $item)
    {
        if (!$this->items) {

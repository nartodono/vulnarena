 ...
 *
 * @Kubernetes\Kind("RoleList",group="rbac.authorization.k8s.io",version="v1")
 *
 * @implements \IteratorAggregate<int, Role>
 */
class RoleList implements IteratorAggregate
{
    /**
    ...
    /**
     * @Kubernetes\Attribute("items",type="collection",model=Role::class,isRequired=true)
     * @var iterable|Role[]
     */
    protected $items;
    ...
    /**
     * @return ArrayIterator|iterable|Role[]
     */
     ...
     * @return static
     */
    public function addItems(Role $item)
    {
        if (!$this->items) {

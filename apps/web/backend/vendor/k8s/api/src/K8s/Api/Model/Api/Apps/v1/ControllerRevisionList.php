 ...
 *
 * @Kubernetes\Kind("ControllerRevisionList",group="apps",version="v1")
 *
 * @implements \IteratorAggregate<int, ControllerRevision>
 */
class ControllerRevisionList implements IteratorAggregate
{
    /**
    ...
    /**
     * @Kubernetes\Attribute("items",type="collection",model=ControllerRevision::class,isRequired=true)
     * @var iterable|ControllerRevision[]
     */
    protected $items;
     ...
     * @var string|null
     */
    protected $kind = 'ControllerRevisionList';
    ...
    /**
     * @param iterable|ControllerRevision[] $items
     */
    ...
    /**
     * @return ArrayIterator|iterable|ControllerRevision[]
     */
     ...
     *
     * @return iterable|ControllerRevision[]
     */
     ...
     * @return static
     */
    public function addItems(ControllerRevision $item)
    {
        if (!$this->items) {

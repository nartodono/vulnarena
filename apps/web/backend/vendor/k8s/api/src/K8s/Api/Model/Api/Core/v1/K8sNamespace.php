 ...
 *
 * @Kubernetes\Kind("Namespace",version="v1")
 * @Kubernetes\Operation("get",path="/api/v1/namespaces/{name}",response="static::class")
 * @Kubernetes\Operation("get-status",path="/api/v1/namespaces/{name}/status",response="static::class")
 * @Kubernetes\Operation("post",path="/api/v1/namespaces",body="model",response="static::class")
 * @Kubernetes\Operation("delete",path="/api/v1/namespaces/{name}",response="K8s\Api\Model\ApiMachinery\Apis\Meta\v1\Status")
 * @Kubernetes\Operation("put",path="/api/v1/namespaces/{name}",body="model",response="static::class")
 * @Kubernetes\Operation("put-status",path="/api/v1/namespaces/{name}/status",body="model",response="static::class")
 * @Kubernetes\Operation("watch-all",path="/api/v1/namespaces",response="K8s\Api\Model\ApiMachinery\Apis\Meta\v1\WatchEvent")
 * @Kubernetes\Operation("patch",path="/api/v1/namespaces/{name}",body="patch",response="static::class")
 * @Kubernetes\Operation("patch-status",path="/api/v1/namespaces/{name}/status",body="patch",response="static::class")
 * @Kubernetes\Operation("list-all",path="/api/v1/namespaces",response="K8s\Api\Model\Api\Core\v1\NamespaceList")
 */
class K8sNamespace
{
    /**
    ...
    /**
     * @Kubernetes\Attribute("spec",type="model",model=NamespaceSpec::class)
     * @var NamespaceSpec
     */
    protected $spec;

    /**
     * @Kubernetes\Attribute("status",type="model",model=NamespaceStatus::class)
     * @var NamespaceStatus|null
     */
    ...
    {
        return $this->spec->getFinalizers();
    }
    ...
    {
        $this->spec->setFinalizers($finalizers);
     ...
     */
    public function getSpec(): NamespaceSpec
    {
        return $this->spec;
    }
     ...
     * @return static
     */
    public function setSpec(NamespaceSpec $spec)
    {
        $this->spec = $spec;
     ...
     * https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#spec-and-status
     */
    public function getStatus(): ?NamespaceStatus
    {
        return $this->status;
    }
     ...
     * @return static
     */
    public function setStatus(NamespaceStatus $status)
    {
        $this->status = $status;

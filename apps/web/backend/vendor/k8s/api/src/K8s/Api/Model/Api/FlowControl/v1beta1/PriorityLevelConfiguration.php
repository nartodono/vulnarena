 ...
 *
 * @Kubernetes\Kind("PriorityLevelConfiguration",group="flowcontrol.apiserver.k8s.io",version="v1beta1")
 * @Kubernetes\Operation("get",path="/apis/flowcontrol.apiserver.k8s.io/v1beta1/prioritylevelconfigurations/{name}",response="static::class")
 * @Kubernetes\Operation("get-status",path="/apis/flowcontrol.apiserver.k8s.io/v1beta1/prioritylevelconfigurations/{name}/status",response="static::class")
 * @Kubernetes\Operation("post",path="/apis/flowcontrol.apiserver.k8s.io/v1beta1/prioritylevelconfigurations",body="model",response="static::class")
 * @Kubernetes\Operation("delete",path="/apis/flowcontrol.apiserver.k8s.io/v1beta1/prioritylevelconfigurations/{name}",response="K8s\Api\Model\ApiMachinery\Apis\Meta\v1\Status")
 * @Kubernetes\Operation("put",path="/apis/flowcontrol.apiserver.k8s.io/v1beta1/prioritylevelconfigurations/{name}",body="model",response="static::class")
 * @Kubernetes\Operation("put-status",path="/apis/flowcontrol.apiserver.k8s.io/v1beta1/prioritylevelconfigurations/{name}/status",body="model",response="static::class")
 * @Kubernetes\Operation("deletecollection-all",path="/apis/flowcontrol.apiserver.k8s.io/v1beta1/prioritylevelconfigurations",response="K8s\Api\Model\ApiMachinery\Apis\Meta\v1\Status")
 * @Kubernetes\Operation("watch-all",path="/apis/flowcontrol.apiserver.k8s.io/v1beta1/prioritylevelconfigurations",response="K8s\Api\Model\ApiMachinery\Apis\Meta\v1\WatchEvent")
 * @Kubernetes\Operation("patch",path="/apis/flowcontrol.apiserver.k8s.io/v1beta1/prioritylevelconfigurations/{name}",body="patch",response="static::class")
 * @Kubernetes\Operation("patch-status",path="/apis/flowcontrol.apiserver.k8s.io/v1beta1/prioritylevelconfigurations/{name}/status",body="patch",response="static::class")
 * @Kubernetes\Operation("list-all",path="/apis/flowcontrol.apiserver.k8s.io/v1beta1/prioritylevelconfigurations",response="K8s\Api\Model\Api\FlowControl\v1beta1\PriorityLevelConfigurationList")
 */
class PriorityLevelConfiguration
{
     ...
     * @var string
     */
    protected $kind = 'PriorityLevelConfiguration';
    ...
    /**
     * @Kubernetes\Attribute("spec",type="model",model=PriorityLevelConfigurationSpec::class)
     * @var PriorityLevelConfigurationSpec
     */
    protected $spec;

    /**
     * @Kubernetes\Attribute("status",type="model",model=PriorityLevelConfigurationStatus::class)
     * @var PriorityLevelConfigurationStatus|null
     */
     ...
     * @return static
     */
    public function setSpec(PriorityLevelConfigurationSpec $spec)
    {
        $this->spec = $spec;
     ...
     * https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#spec-and-status
     */
    public function getStatus(): ?PriorityLevelConfigurationStatus
    {
        return $this->status;
    }
     ...
     * @return static
     */
    public function setStatus(PriorityLevelConfigurationStatus $status)
    {
        $this->status = $status;

 ...
 * @Kubernetes\Operation("get",path="/apis/storage.k8s.io/v1/namespaces/{namespace}/csistoragecapacities/{name}",response="static::class")
 * @Kubernetes\Operation("post",path="/apis/storage.k8s.io/v1/namespaces/{namespace}/csistoragecapacities",body="model",response="static::class")
 * @Kubernetes\Operation("delete",path="/apis/storage.k8s.io/v1/namespaces/{namespace}/csistoragecapacities/{name}",response="K8s\Api\Model\ApiMachinery\Apis\Meta\v1\Status")
 * @Kubernetes\Operation("watch",path="/apis/storage.k8s.io/v1/namespaces/{namespace}/csistoragecapacities",response="K8s\Api\Model\ApiMachinery\Apis\Meta\v1\WatchEvent")
 * @Kubernetes\Operation("put",path="/apis/storage.k8s.io/v1/namespaces/{namespace}/csistoragecapacities/{name}",body="model",response="static::class")
 * @Kubernetes\Operation("deletecollection",path="/apis/storage.k8s.io/v1/namespaces/{namespace}/csistoragecapacities",response="K8s\Api\Model\ApiMachinery\Apis\Meta\v1\Status")
 * @Kubernetes\Operation("watch-all",path="/apis/storage.k8s.io/v1/csistoragecapacities",response="K8s\Api\Model\ApiMachinery\Apis\Meta\v1\WatchEvent")
 * @Kubernetes\Operation("patch",path="/apis/storage.k8s.io/v1/namespaces/{namespace}/csistoragecapacities/{name}",body="patch",response="static::class")
 * @Kubernetes\Operation("list",path="/apis/storage.k8s.io/v1/namespaces/{namespace}/csistoragecapacities",response="K8s\Api\Model\Api\Storage\v1\CSIStorageCapacityList")
 * @Kubernetes\Operation("list-all",path="/apis/storage.k8s.io/v1/csistoragecapacities",response="K8s\Api\Model\Api\Storage\v1\CSIStorageCapacityList")
 */

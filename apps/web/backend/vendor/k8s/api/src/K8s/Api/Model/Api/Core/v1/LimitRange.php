 ...
 *
 * @Kubernetes\Kind("LimitRange",version="v1")
 * @Kubernetes\Operation("get",path="/api/v1/namespaces/{namespace}/limitranges/{name}",response="static::class")
 * @Kubernetes\Operation("post",path="/api/v1/namespaces/{namespace}/limitranges",body="model",response="static::class")
 * @Kubernetes\Operation("delete",path="/api/v1/namespaces/{namespace}/limitranges/{name}",response="K8s\Api\Model\ApiMachinery\Apis\Meta\v1\Status")
 * @Kubernetes\Operation("watch",path="/api/v1/namespaces/{namespace}/limitranges",response="K8s\Api\Model\ApiMachinery\Apis\Meta\v1\WatchEvent")
 * @Kubernetes\Operation("put",path="/api/v1/namespaces/{namespace}/limitranges/{name}",body="model",response="static::class")
 * @Kubernetes\Operation("deletecollection",path="/api/v1/namespaces/{namespace}/limitranges",response="K8s\Api\Model\ApiMachinery\Apis\Meta\v1\Status")
 * @Kubernetes\Operation("watch-all",path="/api/v1/limitranges",response="K8s\Api\Model\ApiMachinery\Apis\Meta\v1\WatchEvent")
 * @Kubernetes\Operation("patch",path="/api/v1/namespaces/{namespace}/limitranges/{name}",body="patch",response="static::class")
 * @Kubernetes\Operation("list",path="/api/v1/namespaces/{namespace}/limitranges",response="K8s\Api\Model\Api\Core\v1\LimitRangeList")
 * @Kubernetes\Operation("list-all",path="/api/v1/limitranges",response="K8s\Api\Model\Api\Core\v1\LimitRangeList")
 */
class LimitRange
{
    /**
    ...
    /**
     * @Kubernetes\Attribute("spec",type="model",model=LimitRangeSpec::class)
     * @var LimitRangeSpec
     */
    protected $spec;
     ...
     */
    public function __construct(?string $name, iterable $limits)
    {
        $this->metadata = new ObjectMeta($name);
        $this->spec = new LimitRangeSpec($limits);
    }
     ...
     */
    public function getSpec(): LimitRangeSpec
    {
        return $this->spec;
    }
     ...
     * @return static
     */
    public function setSpec(LimitRangeSpec $spec)
    {
        $this->spec = $spec;

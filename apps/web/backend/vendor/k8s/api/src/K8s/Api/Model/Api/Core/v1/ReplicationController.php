 ...
 *
 * @Kubernetes\Kind("ReplicationController",version="v1")
 * @Kubernetes\Operation("get",path="/api/v1/namespaces/{namespace}/replicationcontrollers/{name}",response="static::class")
 * @Kubernetes\Operation("get-status",path="/api/v1/namespaces/{namespace}/replicationcontrollers/{name}/status",response="static::class")
 * @Kubernetes\Operation("post",path="/api/v1/namespaces/{namespace}/replicationcontrollers",body="model",response="static::class")
 * @Kubernetes\Operation("delete",path="/api/v1/namespaces/{namespace}/replicationcontrollers/{name}",response="K8s\Api\Model\ApiMachinery\Apis\Meta\v1\Status")
 * @Kubernetes\Operation("watch",path="/api/v1/namespaces/{namespace}/replicationcontrollers",response="K8s\Api\Model\ApiMachinery\Apis\Meta\v1\WatchEvent")
 * @Kubernetes\Operation("put",path="/api/v1/namespaces/{namespace}/replicationcontrollers/{name}",body="model",response="static::class")
 * @Kubernetes\Operation("put-status",path="/api/v1/namespaces/{namespace}/replicationcontrollers/{name}/status",body="model",response="static::class")
 * @Kubernetes\Operation("deletecollection",path="/api/v1/namespaces/{namespace}/replicationcontrollers",response="K8s\Api\Model\ApiMachinery\Apis\Meta\v1\Status")
 * @Kubernetes\Operation("watch-all",path="/api/v1/replicationcontrollers",response="K8s\Api\Model\ApiMachinery\Apis\Meta\v1\WatchEvent")
 * @Kubernetes\Operation("patch",path="/api/v1/namespaces/{namespace}/replicationcontrollers/{name}",body="patch",response="static::class")
 * @Kubernetes\Operation("patch-status",path="/api/v1/namespaces/{namespace}/replicationcontrollers/{name}/status",body="patch",response="static::class")
 * @Kubernetes\Operation("list",path="/api/v1/namespaces/{namespace}/replicationcontrollers",response="K8s\Api\Model\Api\Core\v1\ReplicationControllerList")
 * @Kubernetes\Operation("list-all",path="/api/v1/replicationcontrollers",response="K8s\Api\Model\Api\Core\v1\ReplicationControllerList")
 */
class ReplicationController
{
     ...
     * @var string
     */
    protected $kind = 'ReplicationController';
    ...
    /**
     * @Kubernetes\Attribute("spec",type="model",model=ReplicationControllerSpec::class)
     * @var ReplicationControllerSpec
     */
    protected $spec;

    /**
     * @Kubernetes\Attribute("status",type="model",model=ReplicationControllerStatus::class)
     * @var ReplicationControllerStatus|null
     */
    ...
    /**
     * If the Labels of a ReplicationController are empty, they are defaulted to be the same as the Pod(s)
     * that the replication controller manages. Standard object's metadata. More info:
     * https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#metadata
     */
     ...
     */
    public function getSpec(): ReplicationControllerSpec
    {
        return $this->spec;
    }
     ...
     * @return static
     */
    public function setSpec(ReplicationControllerSpec $spec)
    {
        $this->spec = $spec;
    ...
    /**
     * Status is the most recently observed status of the replication controller. This data may be out of
     * date by some window of time. Populated by the system. Read-only. More info:
     * https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#spec-and-status
     */
    public function getStatus(): ?ReplicationControllerStatus
    {
        return $this->status;
    }
}

 ...
 * @Kubernetes\Operation("get",path="/api/v1/namespaces/{namespace}/secrets/{name}",response="static::class")
 * @Kubernetes\Operation("post",path="/api/v1/namespaces/{namespace}/secrets",body="model",response="static::class")
 * @Kubernetes\Operation("delete",path="/api/v1/namespaces/{namespace}/secrets/{name}",response="K8s\Api\Model\ApiMachinery\Apis\Meta\v1\Status")
 * @Kubernetes\Operation("watch",path="/api/v1/namespaces/{namespace}/secrets",response="K8s\Api\Model\ApiMachinery\Apis\Meta\v1\WatchEvent")
 * @Kubernetes\Operation("put",path="/api/v1/namespaces/{namespace}/secrets/{name}",body="model",response="static::class")
 * @Kubernetes\Operation("deletecollection",path="/api/v1/namespaces/{namespace}/secrets",response="K8s\Api\Model\ApiMachinery\Apis\Meta\v1\Status")
 * @Kubernetes\Operation("watch-all",path="/api/v1/secrets",response="K8s\Api\Model\ApiMachinery\Apis\Meta\v1\WatchEvent")
 * @Kubernetes\Operation("patch",path="/api/v1/namespaces/{namespace}/secrets/{name}",body="patch",response="static::class")
 * @Kubernetes\Operation("list",path="/api/v1/namespaces/{namespace}/secrets",response="K8s\Api\Model\Api\Core\v1\SecretList")
 * @Kubernetes\Operation("list-all",path="/api/v1/secrets",response="K8s\Api\Model\Api\Core\v1\SecretList")
 */
class Secret
{
    /**
    ...
    /**
     * @Kubernetes\Attribute("stringData")
     * @var string[]|null
     */
    protected $stringData = null;
     ...
     * @return static
     */
    public function setStringData(array $stringData)
    {

 ...
 *
 * @Kubernetes\Kind("PodDisruptionBudgetList",group="policy",version="v1")
 *
 * @implements \IteratorAggregate<int, PodDisruptionBudget>
 */
class PodDisruptionBudgetList implements IteratorAggregate
{
    /**
    ...
    /**
     * @Kubernetes\Attribute("items",type="collection",model=PodDisruptionBudget::class,isRequired=true)
     * @var iterable|PodDisruptionBudget[]
     */
    protected $items;
     ...
     * @var string|null
     */
    protected $kind = 'PodDisruptionBudgetList';
    ...
    /**
     * @param iterable|PodDisruptionBudget[] $items
     */
    ...
    /**
     * @return ArrayIterator|iterable|PodDisruptionBudget[]
     */
     ...
     *
     * @return iterable|PodDisruptionBudget[]
     */
     ...
     * @return static
     */
    public function addItems(PodDisruptionBudget $item)
    {
        if (!$this->items) {

 ...
 *
 * @Kubernetes\Kind("MutatingWebhookConfigurationList",group="admissionregistration.k8s.io",version="v1")
 *
 * @implements \IteratorAggregate<int, MutatingWebhookConfiguration>
 */
class MutatingWebhookConfigurationList implements IteratorAggregate
{
    /**
    ...
    /**
     * @Kubernetes\Attribute("items",type="collection",model=MutatingWebhookConfiguration::class,isRequired=true)
     * @var iterable|MutatingWebhookConfiguration[]
     */
    protected $items;
     ...
     * @var string|null
     */
    protected $kind = 'MutatingWebhookConfigurationList';
    ...
    /**
     * @param iterable|MutatingWebhookConfiguration[] $items
     */
    ...
    /**
     * @return ArrayIterator|iterable|MutatingWebhookConfiguration[]
     */
     ...
     *
     * @return iterable|MutatingWebhookConfiguration[]
     */
     ...
     * @return static
     */
    public function addItems(MutatingWebhookConfiguration $item)
    {
        if (!$this->items) {

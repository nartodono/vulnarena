 ...
 * be deleted. Note that, due to its use by both the DaemonSet and StatefulSet controllers for update
 * and rollback, this object is beta. However, it may be subject to name and representation changes in
 * future releases, and clients should not depend on its stability. It is primarily for internal use by
 * controllers.
 *
 * @Kubernetes\Kind("ControllerRevision",group="apps",version="v1")
 * @Kubernetes\Operation("get",path="/apis/apps/v1/namespaces/{namespace}/controllerrevisions/{name}",response="static::class")
 * @Kubernetes\Operation("post",path="/apis/apps/v1/namespaces/{namespace}/controllerrevisions",body="model",response="static::class")
 * @Kubernetes\Operation("delete",path="/apis/apps/v1/namespaces/{namespace}/controllerrevisions/{name}",response="K8s\Api\Model\ApiMachinery\Apis\Meta\v1\Status")
 * @Kubernetes\Operation("watch",path="/apis/apps/v1/namespaces/{namespace}/controllerrevisions",response="K8s\Api\Model\ApiMachinery\Apis\Meta\v1\WatchEvent")
 * @Kubernetes\Operation("put",path="/apis/apps/v1/namespaces/{namespace}/controllerrevisions/{name}",body="model",response="static::class")
 * @Kubernetes\Operation("deletecollection",path="/apis/apps/v1/namespaces/{namespace}/controllerrevisions",response="K8s\Api\Model\ApiMachinery\Apis\Meta\v1\Status")
 * @Kubernetes\Operation("watch-all",path="/apis/apps/v1/controllerrevisions",response="K8s\Api\Model\ApiMachinery\Apis\Meta\v1\WatchEvent")
 * @Kubernetes\Operation("patch",path="/apis/apps/v1/namespaces/{namespace}/controllerrevisions/{name}",body="patch",response="static::class")
 * @Kubernetes\Operation("list",path="/apis/apps/v1/namespaces/{namespace}/controllerrevisions",response="K8s\Api\Model\Api\Apps\v1\ControllerRevisionList")
 * @Kubernetes\Operation("list-all",path="/apis/apps/v1/controllerrevisions",response="K8s\Api\Model\Api\Apps\v1\ControllerRevisionList")
 */
class ControllerRevision
{
     ...
     * @var string|null
     */
    protected $kind = 'ControllerRevision';
    ...
    /**
     * @Kubernetes\Attribute("revision",isRequired=true)
     * @var int
     */
    protected $revision;

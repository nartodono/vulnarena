 ...
 *
 * @Kubernetes\Kind("EventList",group="events.k8s.io",version="v1")
 *
...
class EventList implements IteratorAggregate
{
    ...
    /**
     * @Kubernetes\Attribute("items",type="collection",model=Event::class,isRequired=true)
     * @var iterable|Event[]
     */
    protected $items;
    ...
    /**
     * @return ArrayIterator|iterable|Event[]
     */
     ...
     * @return static
     */
    public function addItems(Event $item)
    {
        if (!$this->items) {

 ...
 *
 * @Kubernetes\Kind("NodeList",version="v1")
 *
...
class NodeList implements IteratorAggregate
{
    ...
    /**
     * @Kubernetes\Attribute("items",type="collection",model=Node::class,isRequired=true)
     * @var iterable|Node[]
     */
    protected $items;
    ...
    /**
     * @return ArrayIterator|iterable|Node[]
     */
     ...
     * @return static
     */
    public function addItems(Node $item)
    {
        if (!$this->items) {

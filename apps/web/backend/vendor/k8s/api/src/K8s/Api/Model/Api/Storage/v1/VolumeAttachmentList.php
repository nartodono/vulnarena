 ...
 *
 * @Kubernetes\Kind("VolumeAttachmentList",group="storage.k8s.io",version="v1")
 *
 * @implements \IteratorAggregate<int, VolumeAttachment>
 */
class VolumeAttachmentList implements IteratorAggregate
{
    /**
    ...
    /**
     * @Kubernetes\Attribute("items",type="collection",model=VolumeAttachment::class,isRequired=true)
     * @var iterable|VolumeAttachment[]
     */
    protected $items;
     ...
     * @var string|null
     */
    protected $kind = 'VolumeAttachmentList';
    ...
    /**
     * @param iterable|VolumeAttachment[] $items
     */
    ...
    /**
     * @return ArrayIterator|iterable|VolumeAttachment[]
     */
     ...
     *
     * @return iterable|VolumeAttachment[]
     */
     ...
     * @return static
     */
    public function addItems(VolumeAttachment $item)
    {
        if (!$this->items) {

...
class PersistentVolumeClaimTemplate
{
    ...
    /**
     * @Kubernetes\Attribute("spec",type="model",model=PersistentVolumeClaimSpec::class,isRequired=true)
     ...
     */
    public function __construct(?string $name, PersistentVolumeClaimSpec $spec)
    {

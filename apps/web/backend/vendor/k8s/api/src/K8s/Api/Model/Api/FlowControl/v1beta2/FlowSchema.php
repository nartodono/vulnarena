 ...
 *
 * @Kubernetes\Kind("FlowSchema",group="flowcontrol.apiserver.k8s.io",version="v1beta2")
 * @Kubernetes\Operation("get",path="/apis/flowcontrol.apiserver.k8s.io/v1beta2/flowschemas/{name}",response="static::class")
 * @Kubernetes\Operation("get-status",path="/apis/flowcontrol.apiserver.k8s.io/v1beta2/flowschemas/{name}/status",response="static::class")
 * @Kubernetes\Operation("post",path="/apis/flowcontrol.apiserver.k8s.io/v1beta2/flowschemas",body="model",response="static::class")
 * @Kubernetes\Operation("delete",path="/apis/flowcontrol.apiserver.k8s.io/v1beta2/flowschemas/{name}",response="K8s\Api\Model\ApiMachinery\Apis\Meta\v1\Status")
 * @Kubernetes\Operation("put",path="/apis/flowcontrol.apiserver.k8s.io/v1beta2/flowschemas/{name}",body="model",response="static::class")
 * @Kubernetes\Operation("put-status",path="/apis/flowcontrol.apiserver.k8s.io/v1beta2/flowschemas/{name}/status",body="model",response="static::class")
 * @Kubernetes\Operation("deletecollection-all",path="/apis/flowcontrol.apiserver.k8s.io/v1beta2/flowschemas",response="K8s\Api\Model\ApiMachinery\Apis\Meta\v1\Status")
 * @Kubernetes\Operation("watch-all",path="/apis/flowcontrol.apiserver.k8s.io/v1beta2/flowschemas",response="K8s\Api\Model\ApiMachinery\Apis\Meta\v1\WatchEvent")
 * @Kubernetes\Operation("patch",path="/apis/flowcontrol.apiserver.k8s.io/v1beta2/flowschemas/{name}",body="patch",response="static::class")
 * @Kubernetes\Operation("patch-status",path="/apis/flowcontrol.apiserver.k8s.io/v1beta2/flowschemas/{name}/status",body="patch",response="static::class")
 * @Kubernetes\Operation("list-all",path="/apis/flowcontrol.apiserver.k8s.io/v1beta2/flowschemas",response="K8s\Api\Model\Api\FlowControl\v1beta2\FlowSchemaList")
 */
class FlowSchema
{
    /**
     ...
     * @var string
     */
    protected $apiVersion = 'flowcontrol.apiserver.k8s.io/v1beta2';

    /**
     * @Kubernetes\Attribute("kind")
     * @var string
     */
    protected $kind = 'FlowSchema';
    ...
    /**
     * @Kubernetes\Attribute("spec",type="model",model=FlowSchemaSpec::class)
     * @var FlowSchemaSpec
     */
    protected $spec;

    /**
     * @Kubernetes\Attribute("status",type="model",model=FlowSchemaStatus::class)
     * @var FlowSchemaStatus|null
     */
     ...
     */
    public function __construct(?string $name, PriorityLevelConfigurationReference $priorityLevelConfiguration)
    {
        $this->metadata = new ObjectMeta($name);
        $this->spec = new FlowSchemaSpec($priorityLevelConfiguration);
    }
    ...
    {
        return $this->spec->getDistinguisherMethod();
    }
    ...
    {
        $this->spec->setDistinguisherMethod($distinguisherMethod);
    ...
    {
        return $this->spec->getMatchingPrecedence();
    }
    ...
    {
        $this->spec->setMatchingPrecedence($matchingPrecedence);
    ...
    {
        return $this->spec->getPriorityLevelConfiguration();
    }
    ...
    {
        $this->spec->setPriorityLevelConfiguration($priorityLevelConfiguration);
     ...
     * @return static
     */
    public function setSpec(FlowSchemaSpec $spec)
    {
        $this->spec = $spec;
     ...
     * https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#spec-and-status
     */
    public function getStatus(): ?FlowSchemaStatus
    {
        return $this->status;
    }
     ...
     * @return static
     */
    public function setStatus(FlowSchemaStatus $status)
    {
        $this->status = $status;

 ...
 *
 * @Kubernetes\Kind("SelfSubjectAccessReview",group="authorization.k8s.io",version="v1")
 * @Kubernetes\Operation("post",path="/apis/authorization.k8s.io/v1/selfsubjectaccessreviews",body="model",response="static::class")
 */
class SelfSubjectAccessReview
{
     ...
     * @var string
     */
    protected $kind = 'SelfSubjectAccessReview';
    ...
    /**
     * @Kubernetes\Attribute("spec",type="model",model=SelfSubjectAccessReviewSpec::class,isRequired=true)
    ...
    /**
     * @param SelfSubjectAccessReviewSpec $spec
     */
    public function __construct(?string $name, SelfSubjectAccessReviewSpec $spec)
    {
     ...
     */
    public function getSpec(): SelfSubjectAccessReviewSpec
    {
        return $this->spec;
    }
     ...
     * @return static
     */
    public function setSpec(SelfSubjectAccessReviewSpec $spec)
    {
        $this->spec = $spec;

 ...
 *
 * @Kubernetes\Kind("APIServiceList",group="apiregistration.k8s.io",version="v1")
 *
 * @implements \IteratorAggregate<int, APIService>
 */
class APIServiceList implements IteratorAggregate
{
    /**
    ...
    /**
     * @Kubernetes\Attribute("items",type="collection",model=APIService::class,isRequired=true)
     * @var iterable|APIService[]
     */
    protected $items;
    ...
    /**
     * @param iterable|APIService[] $items
     */
    ...
    /**
     * @return ArrayIterator|iterable|APIService[]
     */
     ...
     * @return static
     */
    public function addItems(APIService $item)
    {
        if (!$this->items) {

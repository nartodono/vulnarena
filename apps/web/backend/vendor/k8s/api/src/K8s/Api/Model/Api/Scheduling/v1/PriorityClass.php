...
namespace K8s\Api\Model\Api\Scheduling\v1;
 ...
 * @Kubernetes\Operation("get",path="/apis/scheduling.k8s.io/v1/priorityclasses/{name}",response="static::class")
 * @Kubernetes\Operation("post",path="/apis/scheduling.k8s.io/v1/priorityclasses",body="model",response="static::class")
 * @Kubernetes\Operation("delete",path="/apis/scheduling.k8s.io/v1/priorityclasses/{name}",response="K8s\Api\Model\ApiMachinery\Apis\Meta\v1\Status")
 * @Kubernetes\Operation("put",path="/apis/scheduling.k8s.io/v1/priorityclasses/{name}",body="model",response="static::class")
 * @Kubernetes\Operation("deletecollection-all",path="/apis/scheduling.k8s.io/v1/priorityclasses",response="K8s\Api\Model\ApiMachinery\Apis\Meta\v1\Status")
 * @Kubernetes\Operation("watch-all",path="/apis/scheduling.k8s.io/v1/priorityclasses",response="K8s\Api\Model\ApiMachinery\Apis\Meta\v1\WatchEvent")
 * @Kubernetes\Operation("patch",path="/apis/scheduling.k8s.io/v1/priorityclasses/{name}",body="patch",response="static::class")
 * @Kubernetes\Operation("list-all",path="/apis/scheduling.k8s.io/v1/priorityclasses",response="K8s\Api\Model\Api\Scheduling\v1\PriorityClassList")
 */
class PriorityClass
{
    /**
    ...
    /**
     * @Kubernetes\Attribute("globalDefault")
     * @var bool|null
     */
    protected $globalDefault = null;

    /**
     * @Kubernetes\Attribute("kind")
     * @var string|null
     */
    protected $kind = 'PriorityClass';
    ...
    /**
     * globalDefault specifies whether this PriorityClass should be considered as the default priority for
     * pods that do not have any priority class. Only one PriorityClass can be marked as `globalDefault`.
     * However, if more than one PriorityClasses exists with their `globalDefault` field set to true, the
     ...
     * @return static
     */
    public function setIsGlobalDefault(bool $globalDefault)
    {

 ...
 *
 * @Kubernetes\Kind("PersistentVolumeClaimList",version="v1")
 *
 * @implements \IteratorAggregate<int, PersistentVolumeClaim>
 */
class PersistentVolumeClaimList implements IteratorAggregate
{
    /**
    ...
    /**
     * @Kubernetes\Attribute("items",type="collection",model=PersistentVolumeClaim::class,isRequired=true)
     * @var iterable|PersistentVolumeClaim[]
     */
    protected $items;
     ...
     * @var string|null
     */
    protected $kind = 'PersistentVolumeClaimList';
    ...
    /**
     * @param iterable|PersistentVolumeClaim[] $items
     */
    ...
    /**
     * @return ArrayIterator|iterable|PersistentVolumeClaim[]
     */
     ...
     * @return static
     */
    public function addItems(PersistentVolumeClaim $item)
    {
        if (!$this->items) {

 ...
 *
 * @Kubernetes\Kind("FlowSchemaList",group="flowcontrol.apiserver.k8s.io",version="v1beta2")
 *
 * @implements \IteratorAggregate<int, FlowSchema>
 */
class FlowSchemaList implements IteratorAggregate
{
    /**
    ...
    /**
     * @Kubernetes\Attribute("items",type="collection",model=FlowSchema::class,isRequired=true)
     * @var iterable|FlowSchema[]
     */
    protected $items;
    ...
    /**
     * @param iterable|FlowSchema[] $items
     */
    ...
    /**
     * @return ArrayIterator|iterable|FlowSchema[]
     */
     ...
     * @return static
     */
    public function addItems(FlowSchema $item)
    {
        if (!$this->items) {

 ...
 *
 * @Kubernetes\Kind("RoleBindingList",group="rbac.authorization.k8s.io",version="v1")
 *
 * @implements \IteratorAggregate<int, RoleBinding>
 */
class RoleBindingList implements IteratorAggregate
{
    /**
    ...
    /**
     * @Kubernetes\Attribute("items",type="collection",model=RoleBinding::class,isRequired=true)
     * @var iterable|RoleBinding[]
     */
    protected $items;
     ...
     * @var string|null
     */
    protected $kind = 'RoleBindingList';
    ...
    /**
     * @param iterable|RoleBinding[] $items
     */
    ...
    /**
     * @return ArrayIterator|iterable|RoleBinding[]
     */
     ...
     * @return static
     */
    public function addItems(RoleBinding $item)
    {
        if (!$this->items) {

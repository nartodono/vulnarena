 ...
 *
 * @Kubernetes\Kind("PodList",version="v1")
 *
 * @implements \IteratorAggregate<int, Pod>
 */
class PodList implements IteratorAggregate
{
    ...
    /**
     * @Kubernetes\Attribute("items",type="collection",model=Pod::class,isRequired=true)
     * @var iterable|Pod[]
     */
    protected $items;
    ...
    /**
     * @return ArrayIterator|iterable|Pod[]
     */
     ...
     * @return static
     */
    public function addItems(Pod $item)
    {
        if (!$this->items) {

 ...
 *
 * @Kubernetes\Kind("PriorityLevelConfigurationList",group="flowcontrol.apiserver.k8s.io",version="v1beta2")
 *
 * @implements \IteratorAggregate<int, PriorityLevelConfiguration>
 */
class PriorityLevelConfigurationList implements IteratorAggregate
{
    /**
    ...
    /**
     * @Kubernetes\Attribute("items",type="collection",model=PriorityLevelConfiguration::class,isRequired=true)
     * @var iterable|PriorityLevelConfiguration[]
     */
    protected $items;
     ...
     * @var string|null
     */
    protected $kind = 'PriorityLevelConfigurationList';
    ...
    /**
     * @param iterable|PriorityLevelConfiguration[] $items
     */
    ...
    /**
     * @return ArrayIterator|iterable|PriorityLevelConfiguration[]
     */
     ...
     *
     * @return iterable|PriorityLevelConfiguration[]
     */
     ...
     * @return static
     */
    public function addItems(PriorityLevelConfiguration $item)
    {
        if (!$this->items) {

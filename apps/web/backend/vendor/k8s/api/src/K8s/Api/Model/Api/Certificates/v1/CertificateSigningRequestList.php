 ...
 *
 * @Kubernetes\Kind("CertificateSigningRequestList",group="certificates.k8s.io",version="v1")
 *
 * @implements \IteratorAggregate<int, CertificateSigningRequest>
 */
class CertificateSigningRequestList implements IteratorAggregate
{
    /**
    ...
    /**
     * @Kubernetes\Attribute("items",type="collection",model=CertificateSigningRequest::class,isRequired=true)
     * @var iterable|CertificateSigningRequest[]
     */
    protected $items;
     ...
     * @var string|null
     */
    protected $kind = 'CertificateSigningRequestList';
    ...
    /**
     * @param iterable|CertificateSigningRequest[] $items
     */
    ...
    /**
     * @return ArrayIterator|iterable|CertificateSigningRequest[]
     */
     ...
     *
     * @return iterable|CertificateSigningRequest[]
     */
     ...
     * @return static
     */
    public function addItems(CertificateSigningRequest $item)
    {
        if (!$this->items) {

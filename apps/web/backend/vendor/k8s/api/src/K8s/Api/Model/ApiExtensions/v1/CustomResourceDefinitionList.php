 ...
 *
 * @Kubernetes\Kind("CustomResourceDefinitionList",group="apiextensions.k8s.io",version="v1")
 *
 * @implements \IteratorAggregate<int, CustomResourceDefinition>
 */
class CustomResourceDefinitionList implements IteratorAggregate
{
    /**
    ...
    /**
     * @Kubernetes\Attribute("items",type="collection",model=CustomResourceDefinition::class,isRequired=true)
     * @var iterable|CustomResourceDefinition[]
     */
    protected $items;
     ...
     * @var string|null
     */
    protected $kind = 'CustomResourceDefinitionList';
    ...
    /**
     * @param iterable|CustomResourceDefinition[] $items
     */
    ...
    /**
     * @return ArrayIterator|iterable|CustomResourceDefinition[]
     */
     ...
     *
     * @return iterable|CustomResourceDefinition[]
     */
     ...
     * @return static
     */
    public function addItems(CustomResourceDefinition $item)
    {
        if (!$this->items) {

 ...
 *
 * @Kubernetes\Kind("StatefulSetList",group="apps",version="v1")
 *
 * @implements \IteratorAggregate<int, StatefulSet>
 */
class StatefulSetList implements IteratorAggregate
{
    /**
    ...
    /**
     * @Kubernetes\Attribute("items",type="collection",model=StatefulSet::class,isRequired=true)
     * @var iterable|StatefulSet[]
     */
    protected $items;
     ...
     * @var string|null
     */
    protected $kind = 'StatefulSetList';
    ...
    /**
     * @param iterable|StatefulSet[] $items
     */
    ...
    /**
     * @return ArrayIterator|iterable|StatefulSet[]
     */
     ...
     * @return static
     */
    public function addItems(StatefulSet $item)
    {
        if (!$this->items) {

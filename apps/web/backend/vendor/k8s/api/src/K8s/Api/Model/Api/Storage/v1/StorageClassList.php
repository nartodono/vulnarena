 ...
 *
 * @Kubernetes\Kind("StorageClassList",group="storage.k8s.io",version="v1")
 *
 * @implements \IteratorAggregate<int, StorageClass>
 */
class StorageClassList implements IteratorAggregate
{
    /**
    ...
    /**
     * @Kubernetes\Attribute("items",type="collection",model=StorageClass::class,isRequired=true)
     * @var iterable|StorageClass[]
     */
    protected $items;
     ...
     * @var string|null
     */
    protected $kind = 'StorageClassList';
    ...
    /**
     * @param iterable|StorageClass[] $items
     */
    ...
    /**
     * @return ArrayIterator|iterable|StorageClass[]
     */
     ...
     * @return static
     */
    public function addItems(StorageClass $item)
    {
        if (!$this->items) {

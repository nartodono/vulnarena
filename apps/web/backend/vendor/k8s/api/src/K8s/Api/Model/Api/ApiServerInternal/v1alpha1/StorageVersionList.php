 ...
 *
 * @Kubernetes\Kind("StorageVersionList",group="internal.apiserver.k8s.io",version="v1alpha1")
 *
 * @implements \IteratorAggregate<int, StorageVersion>
 */
class StorageVersionList implements IteratorAggregate
{
    /**
    ...
    /**
     * @Kubernetes\Attribute("items",type="collection",model=StorageVersion::class,isRequired=true)
     * @var iterable|StorageVersion[]
     */
    protected $items;
     ...
     * @var string|null
     */
    protected $kind = 'StorageVersionList';
    ...
    /**
     * @param iterable|StorageVersion[] $items
     */
    ...
    /**
     * @return ArrayIterator|iterable|StorageVersion[]
     */
     ...
     *
     * @return iterable|StorageVersion[]
     */
     ...
     * @return static
     */
    public function addItems(StorageVersion $item)
    {
        if (!$this->items) {

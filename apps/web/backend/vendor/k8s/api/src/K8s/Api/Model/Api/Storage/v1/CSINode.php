 ...
 * create the CSINode object directly. As long as they use the node-driver-registrar sidecar container,
 * the kubelet will automatically populate the CSINode object for the CSI driver as part of kubelet
 * plugin registration. CSINode has the same name as a node. If the object is missing, it means either
 * there are no CSI Drivers available on the node, or the Kubelet version is low enough that it doesn't
 * create this object. CSINode has an OwnerReference that points to the corresponding node object.
 *
 * @Kubernetes\Kind("CSINode",group="storage.k8s.io",version="v1")
 * @Kubernetes\Operation("get",path="/apis/storage.k8s.io/v1/csinodes/{name}",response="static::class")
 * @Kubernetes\Operation("post",path="/apis/storage.k8s.io/v1/csinodes",body="model",response="static::class")
 * @Kubernetes\Operation("delete",path="/apis/storage.k8s.io/v1/csinodes/{name}",response="static::class")
 * @Kubernetes\Operation("put",path="/apis/storage.k8s.io/v1/csinodes/{name}",body="model",response="static::class")
 * @Kubernetes\Operation("deletecollection-all",path="/apis/storage.k8s.io/v1/csinodes",response="K8s\Api\Model\ApiMachinery\Apis\Meta\v1\Status")
 * @Kubernetes\Operation("watch-all",path="/apis/storage.k8s.io/v1/csinodes",response="K8s\Api\Model\ApiMachinery\Apis\Meta\v1\WatchEvent")
 * @Kubernetes\Operation("patch",path="/apis/storage.k8s.io/v1/csinodes/{name}",body="patch",response="static::class")
 * @Kubernetes\Operation("list-all",path="/apis/storage.k8s.io/v1/csinodes",response="K8s\Api\Model\Api\Storage\v1\CSINodeList")
 */
class CSINode
{
    /**
    ...
    /**
     * @Kubernetes\Attribute("spec",type="model",model=CSINodeSpec::class,isRequired=true)
     * @var CSINodeSpec
     */
    protected $spec;
     ...
     */
    public function __construct(?string $name, iterable $drivers)
    {
        $this->metadata = new ObjectMeta($name);
        $this->spec = new CSINodeSpec($drivers);
    }
     ...
     */
    public function getSpec(): CSINodeSpec
    {
        return $this->spec;
    }
     ...
     * @return static
     */
    public function setSpec(CSINodeSpec $spec)
    {
        $this->spec = $spec;

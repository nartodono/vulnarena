 ...
 *
 * @Kubernetes\Kind("ComponentStatusList",version="v1")
 *
 * @implements \IteratorAggregate<int, ComponentStatus>
 */
class ComponentStatusList implements IteratorAggregate
{
    /**
    ...
    /**
     * @Kubernetes\Attribute("items",type="collection",model=ComponentStatus::class,isRequired=true)
     ...
     * @var string|null
     */
    protected $kind = 'ComponentStatusList';
    ...
    /**
     * @param iterable|ComponentStatus[] $items
     */
    ...
    /**
     * @return ArrayIterator|iterable|ComponentStatus[]
     */
     ...
     * @return static
     */
    public function addItems(ComponentStatus $item)
    {
        if (!$this->items) {

 ...
 *
 * @Kubernetes\Kind("PriorityClassList",group="scheduling.k8s.io",version="v1")
 *
 * @implements \IteratorAggregate<int, PriorityClass>
 */
class PriorityClassList implements IteratorAggregate
{
    /**
    ...
    /**
     * @Kubernetes\Attribute("items",type="collection",model=PriorityClass::class,isRequired=true)
     * @var iterable|PriorityClass[]
     */
    protected $items;
     ...
     * @var string|null
     */
    protected $kind = 'PriorityClassList';
    ...
    /**
     * @param iterable|PriorityClass[] $items
     */
    ...
    /**
     * @return ArrayIterator|iterable|PriorityClass[]
     */
     ...
     * @return static
     */
    public function addItems(PriorityClass $item)
    {
        if (!$this->items) {

 ...
 * @Kubernetes\Operation("delete",path="/apis/batch/v1/namespaces/{namespace}/jobs/{name}",response="K8s\Api\Model\ApiMachinery\Apis\Meta\v1\Status")
...
class Job
{
    ...
    {
        return $this->status->getCompletedIndexes();
    }
    ...
    {
        return $this->status->getUncountedTerminatedPods();
    }

 ...
 *
 * @Kubernetes\Kind("PersistentVolumeList",version="v1")
 *
 * @implements \IteratorAggregate<int, PersistentVolume>
 */
class PersistentVolumeList implements IteratorAggregate
{
    /**
    ...
    /**
     * @Kubernetes\Attribute("items",type="collection",model=PersistentVolume::class,isRequired=true)
     * @var iterable|PersistentVolume[]
     */
    protected $items;
     ...
     * @var string|null
     */
    protected $kind = 'PersistentVolumeList';
    ...
    /**
     * @param iterable|PersistentVolume[] $items
     */
    ...
    /**
     * @return ArrayIterator|iterable|PersistentVolume[]
     */
     ...
     *
     * @return iterable|PersistentVolume[]
     */
     ...
     * @return static
     */
    public function addItems(PersistentVolume $item)
    {
        if (!$this->items) {

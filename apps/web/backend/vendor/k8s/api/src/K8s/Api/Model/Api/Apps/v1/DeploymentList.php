 ...
 *
 * @Kubernetes\Kind("DeploymentList",group="apps",version="v1")
 *
 * @implements \IteratorAggregate<int, Deployment>
 */
class DeploymentList implements IteratorAggregate
{
    ...
    /**
     * @Kubernetes\Attribute("items",type="collection",model=Deployment::class,isRequired=true)
     * @var iterable|Deployment[]
     */
    protected $items;
    ...
    /**
     * @param iterable|Deployment[] $items
     */
    ...
    /**
     * @return ArrayIterator|iterable|Deployment[]
     */
     ...
     * @return static
     */
    public function addItems(Deployment $item)
    {
        if (!$this->items) {

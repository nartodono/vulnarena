 ...
 *
 * @Kubernetes\Kind("TokenRequest",group="authentication.k8s.io",version="v1")
 * @Kubernetes\Operation("post",path="/api/v1/namespaces/{namespace}/serviceaccounts/{name}/token",body="model",response="static::class")
 */
class TokenRequest
{
    /**
    ...
    /**
     * @Kubernetes\Attribute("spec",type="model",model=TokenRequestSpec::class,isRequired=true)
     * @var TokenRequestSpec
     */
    protected $spec;

    /**
     * @Kubernetes\Attribute("status",type="model",model=TokenRequestStatus::class)
     * @var TokenRequestStatus|null
     */
     ...
     */
    public function __construct(?string $name, array $audiences)
    {
        $this->metadata = new ObjectMeta($name);
        $this->spec = new TokenRequestSpec($audiences);
    }
    ...
    {
        return $this->spec->getBoundObjectRef();
    }
    ...
    {
        $this->spec->setBoundObjectRef($boundObjectRef);
    ...
    {
        return $this->status->getExpirationTimestamp();
    }
     ...
     */
    public function getSpec(): TokenRequestSpec
    {
        return $this->spec;
    }
     ...
     * @return static
     */
    public function setSpec(TokenRequestSpec $spec)
    {
        $this->spec = $spec;
     ...
     */
    public function getStatus(): ?TokenRequestStatus
    {
        return $this->status;
    }
     ...
     * @return static
     */
    public function setStatus(TokenRequestStatus $status)
    {
        $this->status = $status;

 ...
 *
 * @Kubernetes\Kind("CSIDriverList",group="storage.k8s.io",version="v1")
 *
 * @implements \IteratorAggregate<int, CSIDriver>
 */
class CSIDriverList implements IteratorAggregate
{
    /**
    ...
    /**
     * @Kubernetes\Attribute("items",type="collection",model=CSIDriver::class,isRequired=true)
     * @var iterable|CSIDriver[]
     */
    protected $items;
    ...
    /**
     * @param iterable|CSIDriver[] $items
     */
    ...
    /**
     * @return ArrayIterator|iterable|CSIDriver[]
     */
     ...
     * @return static
     */
    public function addItems(CSIDriver $item)
    {
        if (!$this->items) {

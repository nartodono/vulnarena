 ...
 *
 * @Kubernetes\Kind("ClusterCIDR",group="networking.k8s.io",version="v1alpha1")
 * @Kubernetes\Operation("get",path="/apis/networking.k8s.io/v1alpha1/clustercidrs/{name}",response="static::class")
 * @Kubernetes\Operation("post",path="/apis/networking.k8s.io/v1alpha1/clustercidrs",body="model",response="static::class")
 * @Kubernetes\Operation("delete",path="/apis/networking.k8s.io/v1alpha1/clustercidrs/{name}",response="K8s\Api\Model\ApiMachinery\Apis\Meta\v1\Status")
 * @Kubernetes\Operation("put",path="/apis/networking.k8s.io/v1alpha1/clustercidrs/{name}",body="model",response="static::class")
 * @Kubernetes\Operation("deletecollection-all",path="/apis/networking.k8s.io/v1alpha1/clustercidrs",response="K8s\Api\Model\ApiMachinery\Apis\Meta\v1\Status")
 * @Kubernetes\Operation("watch-all",path="/apis/networking.k8s.io/v1alpha1/clustercidrs",response="K8s\Api\Model\ApiMachinery\Apis\Meta\v1\WatchEvent")
 * @Kubernetes\Operation("patch",path="/apis/networking.k8s.io/v1alpha1/clustercidrs/{name}",body="patch",response="static::class")
 * @Kubernetes\Operation("list-all",path="/apis/networking.k8s.io/v1alpha1/clustercidrs",response="K8s\Api\Model\Api\Networking\v1alpha1\ClusterCIDRList")
 */
class ClusterCIDR
{
    /**
     ...
     * @var string
     */
    protected $apiVersion = 'networking.k8s.io/v1alpha1';

    /**
     * @Kubernetes\Attribute("kind")
     * @var string
     */
    protected $kind = 'ClusterCIDR';
    ...
    /**
     * @Kubernetes\Attribute("spec",type="model",model=ClusterCIDRSpec::class)
     * @var ClusterCIDRSpec
     */
    protected $spec;
     ...
     */
    public function __construct(?string $name, int $perNodeHostBits)
    {
        $this->metadata = new ObjectMeta($name);
        $this->spec = new ClusterCIDRSpec($perNodeHostBits);
    }
    ...
    {
        return $this->spec->getPerNodeHostBits();
    }
    ...
    {
        $this->spec->setPerNodeHostBits($perNodeHostBits);
     ...
     * @return static
     */
    public function setSpec(ClusterCIDRSpec $spec)
    {
        $this->spec = $spec;

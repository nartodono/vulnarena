 ...
 * @Kubernetes\Operation("get",path="/apis/rbac.authorization.k8s.io/v1/clusterrolebindings/{name}",response="static::class")
 * @Kubernetes\Operation("post",path="/apis/rbac.authorization.k8s.io/v1/clusterrolebindings",body="model",response="static::class")
 * @Kubernetes\Operation("delete",path="/apis/rbac.authorization.k8s.io/v1/clusterrolebindings/{name}",response="K8s\Api\Model\ApiMachinery\Apis\Meta\v1\Status")
 * @Kubernetes\Operation("put",path="/apis/rbac.authorization.k8s.io/v1/clusterrolebindings/{name}",body="model",response="static::class")
 * @Kubernetes\Operation("deletecollection-all",path="/apis/rbac.authorization.k8s.io/v1/clusterrolebindings",response="K8s\Api\Model\ApiMachinery\Apis\Meta\v1\Status")
 * @Kubernetes\Operation("watch-all",path="/apis/rbac.authorization.k8s.io/v1/clusterrolebindings",response="K8s\Api\Model\ApiMachinery\Apis\Meta\v1\WatchEvent")
 * @Kubernetes\Operation("patch",path="/apis/rbac.authorization.k8s.io/v1/clusterrolebindings/{name}",body="patch",response="static::class")
 * @Kubernetes\Operation("list-all",path="/apis/rbac.authorization.k8s.io/v1/clusterrolebindings",response="K8s\Api\Model\Api\Rbac\v1\ClusterRoleBindingList")
 */

 ...
 *
 * @Kubernetes\Kind("ClusterCIDRList",group="networking.k8s.io",version="v1alpha1")
 *
 * @implements \IteratorAggregate<int, ClusterCIDR>
 */
class ClusterCIDRList implements IteratorAggregate
{
    /**
    ...
    /**
     * @Kubernetes\Attribute("items",type="collection",model=ClusterCIDR::class,isRequired=true)
     * @var iterable|ClusterCIDR[]
     */
    protected $items;
     ...
     * @var string|null
     */
    protected $kind = 'ClusterCIDRList';
    ...
    /**
     * @param iterable|ClusterCIDR[] $items
     */
    ...
    /**
     * @return ArrayIterator|iterable|ClusterCIDR[]
     */
     ...
     * @return static
     */
    public function addItems(ClusterCIDR $item)
    {
        if (!$this->items) {

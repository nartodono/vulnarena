 ...
 * deprecated in v1.19+
 *
 * @Kubernetes\Kind("ComponentStatus",version="v1")
 */
class ComponentStatus
{
    ...
    /**
     * @Kubernetes\Attribute("conditions",type="collection",model=ComponentCondition::class)
     * @var iterable|ComponentCondition[]|null
     */
     ...
     * @var string|null
     */
    protected $kind = 'ComponentStatus';
     ...
     *
     * @return iterable|ComponentCondition[]
     */
     ...
     * @return static
     */
    public function addConditions(ComponentCondition $condition)
    {
        if (!$this->conditions) {

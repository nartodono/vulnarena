 ...
 *
 * @Kubernetes\Kind("EndpointsList",version="v1")
 *
 * @implements \IteratorAggregate<int, Endpoints>
 */
class EndpointsList implements IteratorAggregate
{
    /**
    ...
    /**
     * @Kubernetes\Attribute("items",type="collection",model=Endpoints::class,isRequired=true)
     * @var iterable|Endpoints[]
     */
    protected $items;
    ...
    /**
     * @param iterable|Endpoints[] $items
     */
    ...
    /**
     * @return ArrayIterator|iterable|Endpoints[]
     */
     ...
     * @return static
     */
    public function addItems(Endpoints $item)
    {
        if (!$this->items) {

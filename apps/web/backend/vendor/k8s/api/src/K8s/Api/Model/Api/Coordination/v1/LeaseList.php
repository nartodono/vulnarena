 ...
 *
 * @Kubernetes\Kind("LeaseList",group="coordination.k8s.io",version="v1")
 *
 * @implements \IteratorAggregate<int, Lease>
 */
class LeaseList implements IteratorAggregate
{
    /**
    ...
    /**
     * @Kubernetes\Attribute("items",type="collection",model=Lease::class,isRequired=true)
     * @var iterable|Lease[]
     */
    protected $items;
    ...
    /**
     * @return ArrayIterator|iterable|Lease[]
     */
     ...
     * @return static
     */
    public function addItems(Lease $item)
    {
        if (!$this->items) {

 ...
 *
 * @Kubernetes\Kind("ServiceList",version="v1")
 *
 * @implements \IteratorAggregate<int, Service>
 */
class ServiceList implements IteratorAggregate
{
    ...
    /**
     * @Kubernetes\Attribute("items",type="collection",model=Service::class,isRequired=true)
     * @var iterable|Service[]
     */
    protected $items;
    ...
    /**
     * @return ArrayIterator|iterable|Service[]
     */
     ...
     * @return static
     */
    public function addItems(Service $item)
    {
        if (!$this->items) {

 ...
 *
 * @Kubernetes\Kind("ClusterRoleList",group="rbac.authorization.k8s.io",version="v1")
 *
 * @implements \IteratorAggregate<int, ClusterRole>
 */
class ClusterRoleList implements IteratorAggregate
{
    /**
    ...
    /**
     * @Kubernetes\Attribute("items",type="collection",model=ClusterRole::class,isRequired=true)
     * @var iterable|ClusterRole[]
     */
    protected $items;
     ...
     * @var string|null
     */
    protected $kind = 'ClusterRoleList';
    ...
    /**
     * @param iterable|ClusterRole[] $items
     */
    ...
    /**
     * @return ArrayIterator|iterable|ClusterRole[]
     */
     ...
     * @return static
     */
    public function addItems(ClusterRole $item)
    {
        if (!$this->items) {

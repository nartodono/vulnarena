...
use K8s\Api\Model\Api\Core\v1\TopologySelectorTerm;
 ...
 * @Kubernetes\Operation("get",path="/apis/storage.k8s.io/v1/storageclasses/{name}",response="static::class")
 * @Kubernetes\Operation("post",path="/apis/storage.k8s.io/v1/storageclasses",body="model",response="static::class")
 * @Kubernetes\Operation("delete",path="/apis/storage.k8s.io/v1/storageclasses/{name}",response="static::class")
 * @Kubernetes\Operation("put",path="/apis/storage.k8s.io/v1/storageclasses/{name}",body="model",response="static::class")
 * @Kubernetes\Operation("deletecollection-all",path="/apis/storage.k8s.io/v1/storageclasses",response="K8s\Api\Model\ApiMachinery\Apis\Meta\v1\Status")
 * @Kubernetes\Operation("watch-all",path="/apis/storage.k8s.io/v1/storageclasses",response="K8s\Api\Model\ApiMachinery\Apis\Meta\v1\WatchEvent")
 * @Kubernetes\Operation("patch",path="/apis/storage.k8s.io/v1/storageclasses/{name}",body="patch",response="static::class")
 * @Kubernetes\Operation("list-all",path="/apis/storage.k8s.io/v1/storageclasses",response="K8s\Api\Model\Api\Storage\v1\StorageClassList")
 */
class StorageClass
{
    /**
     * @Kubernetes\Attribute("allowVolumeExpansion")
     * @var bool|null
     */
    protected $allowVolumeExpansion = null;

    /**
     * @Kubernetes\Attribute("allowedTopologies",type="collection",model=TopologySelectorTerm::class)
     * @var iterable|TopologySelectorTerm[]|null
     */
    protected $allowedTopologies = null;
    ...
    /**
     * @Kubernetes\Attribute("provisioner",isRequired=true)
     * @var string
     */
    protected $provisioner;

    /**
     * @Kubernetes\Attribute("reclaimPolicy")
     * @var string|null
     */
    protected $reclaimPolicy = null;

    /**
     * @Kubernetes\Attribute("volumeBindingMode")
     * @var string|null
     */
    protected $volumeBindingMode = null;

    /**
     * @param string $provisioner
     */
    public function __construct(?string $name, string $provisioner)
    {
     ...
     */
    public function isAllowVolumeExpansion(): ?bool
    {
     ...
     * @return static
     */
    public function setIsAllowVolumeExpansion(bool $allowVolumeExpansion)
    {
     ...
     * defines its own supported topology specifications. An empty TopologySelectorTerm list means there is
     * no topology restriction. This field is only honored by servers that enable the VolumeScheduling
     * feature.
     *
     * @return iterable|TopologySelectorTerm[]
     */
    public function getAllowedTopologies(): ?iterable
    {
     ...
     * @return static
     */
    public function setAllowedTopologies(iterable $allowedTopologies)
    {
     ...
     * @return static
     */
    public function addAllowedTopologies(TopologySelectorTerm $allowedTopologie)
    {
        if (!$this->allowedTopologies) {
            $this->allowedTopologies = new Collection();
        }
        $this->allowedTopologies[] = $allowedTopologie;
     ...
     * @return static
     */
    public function setReclaimPolicy(string $reclaimPolicy)
    {
     ...
     * VolumeBindingImmediate is used. This field is only honored by servers that enable the
     ...
     * @return static
     */
    public function setVolumeBindingMode(string $volumeBindingMode)
    {

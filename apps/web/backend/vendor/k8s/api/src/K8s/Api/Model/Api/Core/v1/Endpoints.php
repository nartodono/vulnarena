 ...
 * @Kubernetes\Operation("get",path="/api/v1/namespaces/{namespace}/endpoints/{name}",response="static::class")
 * @Kubernetes\Operation("post",path="/api/v1/namespaces/{namespace}/endpoints",body="model",response="static::class")
 * @Kubernetes\Operation("delete",path="/api/v1/namespaces/{namespace}/endpoints/{name}",response="K8s\Api\Model\ApiMachinery\Apis\Meta\v1\Status")
 * @Kubernetes\Operation("watch",path="/api/v1/namespaces/{namespace}/endpoints",response="K8s\Api\Model\ApiMachinery\Apis\Meta\v1\WatchEvent")
 * @Kubernetes\Operation("put",path="/api/v1/namespaces/{namespace}/endpoints/{name}",body="model",response="static::class")
 * @Kubernetes\Operation("deletecollection",path="/api/v1/namespaces/{namespace}/endpoints",response="K8s\Api\Model\ApiMachinery\Apis\Meta\v1\Status")
 * @Kubernetes\Operation("watch-all",path="/api/v1/endpoints",response="K8s\Api\Model\ApiMachinery\Apis\Meta\v1\WatchEvent")
 * @Kubernetes\Operation("patch",path="/api/v1/namespaces/{namespace}/endpoints/{name}",body="patch",response="static::class")
 * @Kubernetes\Operation("list",path="/api/v1/namespaces/{namespace}/endpoints",response="K8s\Api\Model\Api\Core\v1\EndpointsList")
 * @Kubernetes\Operation("list-all",path="/api/v1/endpoints",response="K8s\Api\Model\Api\Core\v1\EndpointsList")
 */
class Endpoints
{
    /**
    ...
    /**
     * @Kubernetes\Attribute("subsets",type="collection",model=EndpointSubset::class)
     * @var iterable|EndpointSubset[]|null
     */
    ...
    /**
     * The set of all endpoints is the union of all subsets. Addresses are placed into subsets according to
     * the IPs they share. A single address with multiple ports, some of which are ready and some of which
     * are not (because they come from different containers) will result in the address being displayed in
     * different subsets for the different ports. No address will appear in both Addresses and
     * NotReadyAddresses in the same subset. Sets of addresses and ports that comprise a service.
     *
     * @return iterable|EndpointSubset[]
     */
    public function getSubsets(): ?iterable
    {
        return $this->subsets;
    }
     ...
     * @return static
     */
    public function setSubsets(iterable $subsets)
    {
     ...
     * @return static
     */
    public function addSubsets(EndpointSubset $subset)
    {
        if (!$this->subsets) {
            $this->subsets = new Collection();
        }
        $this->subsets[] = $subset;

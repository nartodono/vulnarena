 ...
 *
 * @Kubernetes\Kind("EndpointSliceList",group="discovery.k8s.io",version="v1")
 *
 * @implements \IteratorAggregate<int, EndpointSlice>
 */
class EndpointSliceList implements IteratorAggregate
{
    /**
    ...
    /**
     * @Kubernetes\Attribute("items",type="collection",model=EndpointSlice::class,isRequired=true)
     * @var iterable|EndpointSlice[]
     */
    protected $items;
     ...
     * @var string|null
     */
    protected $kind = 'EndpointSliceList';
    ...
    /**
     * @param iterable|EndpointSlice[] $items
     */
    ...
    /**
     * @return ArrayIterator|iterable|EndpointSlice[]
     */
     ...
     * @return static
     */
    public function addItems(EndpointSlice $item)
    {
        if (!$this->items) {

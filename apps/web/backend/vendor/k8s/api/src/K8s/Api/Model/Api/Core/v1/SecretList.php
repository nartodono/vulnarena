 ...
 *
 * @Kubernetes\Kind("SecretList",version="v1")
 *
 * @implements \IteratorAggregate<int, Secret>
 */
class SecretList implements IteratorAggregate
{
    /**
    ...
    /**
     * @Kubernetes\Attribute("items",type="collection",model=Secret::class,isRequired=true)
     * @var iterable|Secret[]
     */
    protected $items;
    ...
    /**
     * @return ArrayIterator|iterable|Secret[]
     */
     ...
     * @return static
     */
    public function addItems(Secret $item)
    {
        if (!$this->items) {

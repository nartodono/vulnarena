 ...
 *
 * @Kubernetes\Kind("CSINodeList",group="storage.k8s.io",version="v1")
 *
 * @implements \IteratorAggregate<int, CSINode>
 */
class CSINodeList implements IteratorAggregate
{
    /**
    ...
    /**
     * @Kubernetes\Attribute("items",type="collection",model=CSINode::class,isRequired=true)
     * @var iterable|CSINode[]
     */
    protected $items;
    ...
    /**
     * @return ArrayIterator|iterable|CSINode[]
     */
     ...
     * @return static
     */
    public function addItems(CSINode $item)
    {
        if (!$this->items) {

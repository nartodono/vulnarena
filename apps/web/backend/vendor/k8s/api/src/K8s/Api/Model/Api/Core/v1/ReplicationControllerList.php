 ...
 *
 * @Kubernetes\Kind("ReplicationControllerList",version="v1")
 *
 * @implements \IteratorAggregate<int, ReplicationController>
 */
class ReplicationControllerList implements IteratorAggregate
{
    ...
    /**
     * @Kubernetes\Attribute("items",type="collection",model=ReplicationController::class,isRequired=true)
     * @var iterable|ReplicationController[]
     */
    protected $items;
     ...
     * @var string|null
     */
    protected $kind = 'ReplicationControllerList';
    ...
    /**
     * @param iterable|ReplicationController[] $items
     */
    ...
    /**
     * @return ArrayIterator|iterable|ReplicationController[]
     */
     ...
     *
     * @return iterable|ReplicationController[]
     */
     ...
     * @return static
     */
    public function addItems(ReplicationController $item)
    {
        if (!$this->items) {

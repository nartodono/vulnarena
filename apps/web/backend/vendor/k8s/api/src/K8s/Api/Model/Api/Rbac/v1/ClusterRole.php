 ...
 *
 * @Kubernetes\Kind("ClusterRole",group="rbac.authorization.k8s.io",version="v1")
 * @Kubernetes\Operation("get",path="/apis/rbac.authorization.k8s.io/v1/clusterroles/{name}",response="static::class")
 * @Kubernetes\Operation("post",path="/apis/rbac.authorization.k8s.io/v1/clusterroles",body="model",response="static::class")
 * @Kubernetes\Operation("delete",path="/apis/rbac.authorization.k8s.io/v1/clusterroles/{name}",response="K8s\Api\Model\ApiMachinery\Apis\Meta\v1\Status")
 * @Kubernetes\Operation("put",path="/apis/rbac.authorization.k8s.io/v1/clusterroles/{name}",body="model",response="static::class")
 * @Kubernetes\Operation("deletecollection-all",path="/apis/rbac.authorization.k8s.io/v1/clusterroles",response="K8s\Api\Model\ApiMachinery\Apis\Meta\v1\Status")
 * @Kubernetes\Operation("watch-all",path="/apis/rbac.authorization.k8s.io/v1/clusterroles",response="K8s\Api\Model\ApiMachinery\Apis\Meta\v1\WatchEvent")
 * @Kubernetes\Operation("patch",path="/apis/rbac.authorization.k8s.io/v1/clusterroles/{name}",body="patch",response="static::class")
 * @Kubernetes\Operation("list-all",path="/apis/rbac.authorization.k8s.io/v1/clusterroles",response="K8s\Api\Model\Api\Rbac\v1\ClusterRoleList")
 */
class ClusterRole
{
    /**
     * @Kubernetes\Attribute("aggregationRule",type="model",model=AggregationRule::class)
     * @var AggregationRule|null
     */
    protected $aggregationRule = null;
    ...
    /**
     * @Kubernetes\Attribute("rules",type="collection",model=PolicyRule::class)
     * @var iterable|PolicyRule[]|null
     */
    ...
    /**
     * AggregationRule is an optional field that describes how to build the Rules for this ClusterRole. If
     * AggregationRule is set, then the Rules are controller managed and direct changes to Rules will be
     * stomped by the controller.
     */
    public function getAggregationRule(): ?AggregationRule
    {
     ...
     * @return static
     */
    public function setAggregationRule(AggregationRule $aggregationRule)
    {

 ...
 *
 * @Kubernetes\Kind("PodTemplateList",version="v1")
 *
 * @implements \IteratorAggregate<int, PodTemplate>
 */
class PodTemplateList implements IteratorAggregate
{
    /**
    ...
    /**
     * @Kubernetes\Attribute("items",type="collection",model=PodTemplate::class,isRequired=true)
     * @var iterable|PodTemplate[]
     */
    protected $items;
     ...
     * @var string|null
     */
    protected $kind = 'PodTemplateList';
    ...
    /**
     * @param iterable|PodTemplate[] $items
     */
    ...
    /**
     * @return ArrayIterator|iterable|PodTemplate[]
     */
     ...
     * @return static
     */
    public function addItems(PodTemplate $item)
    {
        if (!$this->items) {

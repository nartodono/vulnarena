 ...
 *
 * @Kubernetes\Kind("RuntimeClassList",group="node.k8s.io",version="v1")
 *
 * @implements \IteratorAggregate<int, RuntimeClass>
 */
class RuntimeClassList implements IteratorAggregate
{
    /**
    ...
    /**
     * @Kubernetes\Attribute("items",type="collection",model=RuntimeClass::class,isRequired=true)
     * @var iterable|RuntimeClass[]
     */
    protected $items;
     ...
     * @var string|null
     */
    protected $kind = 'RuntimeClassList';
    ...
    /**
     * @param iterable|RuntimeClass[] $items
     */
    ...
    /**
     * @return ArrayIterator|iterable|RuntimeClass[]
     */
     ...
     * @return static
     */
    public function addItems(RuntimeClass $item)
    {
        if (!$this->items) {

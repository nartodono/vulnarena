 ...
 *
 * @Kubernetes\Kind("ConfigMapList",version="v1")
 *
 * @implements \IteratorAggregate<int, ConfigMap>
 */
class ConfigMapList implements IteratorAggregate
{
    /**
    ...
    /**
     * @Kubernetes\Attribute("items",type="collection",model=ConfigMap::class,isRequired=true)
     * @var iterable|ConfigMap[]
     */
    protected $items;
    ...
    /**
     * @param iterable|ConfigMap[] $items
     */
    ...
    /**
     * @return ArrayIterator|iterable|ConfigMap[]
     */
     ...
     * @return static
     */
    public function addItems(ConfigMap $item)
    {
        if (!$this->items) {

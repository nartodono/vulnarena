...
class ValidatingWebhookConfigurationList implements IteratorAggregate
{
    ...
    /**
     * @Kubernetes\Attribute("items",type="collection",model=ValidatingWebhookConfiguration::class,isRequired=true)
     ...
     * @var string|null
     */
    protected $kind = 'ValidatingWebhookConfigurationList';
     ...
     * @return static
     */
    public function addItems(ValidatingWebhookConfiguration $item)
    {
        if (!$this->items) {

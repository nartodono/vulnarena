 ...
 *
 * @Kubernetes\Kind("Binding",version="v1")
 * @Kubernetes\Operation("post",path="/api/v1/namespaces/{namespace}/bindings",body="model",response="static::class")
 */
class Binding
{
    /**
    ...
    /**
     * @Kubernetes\Attribute("target",type="model",model=ObjectReference::class,isRequired=true)
     * @var ObjectReference
     */
    protected $target;

    /**
     * @param ObjectReference $target
     */
    public function __construct(?string $name, ObjectReference $target)
    {
     ...
     */
    public function getTarget(): ObjectReference
    {
        return $this->target;
    }
     ...
     * @return static
     */
    public function setTarget(ObjectReference $target)
    {
        $this->target = $target;
